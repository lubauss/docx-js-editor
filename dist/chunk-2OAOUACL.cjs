'use strict';
var chunk3BS5FKGU_cjs = require('./chunk-3BS5FKGU.cjs'),
  chunkT2HQYRA7_cjs = require('./chunk-T2HQYRA7.cjs'),
...
var ro = ({ action: e, onClick: t, isHighlighted: o, onMouseEnter: r }) => {
    let i = chunkT2HQYRA7_cjs.e(e),
      n = chunkT2HQYRA7_cjs.f(e),
      a = oo(e);
    return jsxRuntime.jsxs('button', {
      ...
      children: [
        ...
        jsxRuntime.jsx('span', { children: i }),
      ],
    });
  },
  ...
  Dn = ({
    ...
    onAction: i,
    onClose: n,
    actions: a = chunkT2HQYRA7_cjs.g,
    showCustomPrompt: g = true,
    className: s = '',
  }) => {
    let l = nr.useRef(null),
      [f, m] = nr.useState(0),
      [p, c] = nr.useState(false),
      h = g ? [...a, 'custom'] : a;
    (nr.useEffect(() => {
      if (!e) return;
      let u = (v) => {
...
function Mn() {
  let [e, t] = nr.useState(false),
    [o, r] = nr.useState({ x: 0, y: 0 }),
    [i, n] = nr.useState(''),
    [a, g] = nr.useState(),
    s = nr.useCallback((f, m, p) => {
...
var po = ({ original: e, modified: t }) => {
    ...
    return jsxRuntime.jsx('div', {
      ...
      children: o.map((r, i) => {
        ...
        return jsxRuntime.jsx('span', { style: n, children: r.text }, i);
      }),
    });
  },
  Un = ({
          ...
          children: jsxRuntime.jsxs('div', {
            ...
            children: [
              ...
              jsxRuntime.jsxs('div', {
                ...
                children: [chunkT2HQYRA7_cjs.e(o), '...'],
              }),
            ],
          }),
        })
                ...
                jsxRuntime.jsxs('div', {
                  ...
                  children: [
                    jsxRuntime.jsxs('div', {
                      ...
                      children: [chunkT2HQYRA7_cjs.e(o), ' Result'],
                    }),
                    jsxRuntime.jsx('button', {
                      type: 'button',
                      onClick: a,
                  ...
                  children: [
                      ...
                      : l
                        ? jsxRuntime.jsxs('div', {
                            children: [
                              ...
                              jsxRuntime.jsx(po, { original: e, modified: u }),
                            ],
                          })
                        : jsxRuntime.jsxs('div', {
                            children: [
                    ...
                    t.warnings &&
                      ...
                      jsxRuntime.jsx('div', {
                        ...
                        children: t.warnings.map((I, A) =>
                          jsxRuntime.jsx('div', { children: I }, A)
                        ),
                      }),
                  ],
                }),
                    ...
                    jsxRuntime.jsxs('div', {
                      ...
                      children: [
                        jsxRuntime.jsxs('button', {
                          ...
                          children: [jsxRuntime.jsx(ct, {}), 'Reject'],
                        }),
                        jsxRuntime.jsxs('button', {
                          type: 'button',
                          onClick: v,
...
function bo(e) {
  switch (e) {
    case 'cut':
      return jsxRuntime.jsx(go, {});
    case 'copy':
      return jsxRuntime.jsx(mo, {});
    case 'paste':
    case 'pasteAsPlainText':
      return jsxRuntime.jsx(xo, {});
    case 'delete':
      return jsxRuntime.jsx(fo, {});
    case 'selectAll':
      return jsxRuntime.jsx(ho, {});
    default:
      return null;
  }
}
...
function Jn(e = {}) {
  let { enabled: t = true, isEditable: o = true, containerRef: r, onAction: i } = e,
    [n, a] = nr.useState(false),
    [g, s] = nr.useState({ x: 0, y: 0 }),
    [l, f] = nr.useState(false),
    m = nr.useCallback(() => {
...
var Co = [
  ...
  Bo = () => jsxRuntime.jsx(chunk3BS5FKGU_cjs.d, { name: 'format_color_text', size: 18 }),
  zo = () => jsxRuntime.jsx(chunk3BS5FKGU_cjs.d, { name: 'ink_highlighter', size: 18 }),
  Wo = () => jsxRuntime.jsx(chunk3BS5FKGU_cjs.d, { name: 'arrow_drop_down', size: 14 });
function Yo({ colors: e, selectedColor: t, onSelect: o, columns: r = 10, cellSize: i = 20 }) {
  let [n, a] = nr.useState(null),
      ...
      return (
        ...
        jsxRuntime.jsx(
          'button',
          {
            ...
            'aria-label': s.name,
            'aria-selected': f,
            children: p && jsxRuntime.jsx('span', { style: Mo }),
          },
          `${s.hex}-${l}`
        )
      );
...
function ci({
  ...
  let [c, h] = nr.useState(false),
    [b, d] = nr.useState(false),
    [x, u] = nr.useState(''),
    v = nr.useCallback(() => h(false), []),
    {
      containerRef: C,
      dropdownRef: R,
      dropdownStyle: H,
    } = chunk3BS5FKGU_cjs.e({ isOpen: c, onClose: v }),
    I = nr.useMemo(() => {
      ...
      () =>
        e
          ? e.startsWith('#')
            ? e
            : o === 'highlight'
              ? chunkIHVS6O3T_cjs.b(e) || 'transparent'
              : `#${e}`
          : o === 'text'
            ? '#000000'
            : 'transparent',
    ...
    children: [
        ...
        children: [
          l ||
            jsxRuntime.jsxs('div', {
              style: Io,
              children: [
                o === 'text' ? jsxRuntime.jsx(Bo, {}) : jsxRuntime.jsx(zo, {}),
                jsxRuntime.jsx('div', {
                  style: {
                    ...Po,
      ...
      c &&
        jsxRuntime.jsxs('div', {
          ...
          onMouseDown: (M) => M.preventDefault(),
          children: [
            o === 'highlight' && jsxRuntime.jsx('div', { style: ut, children: 'Highlight Colors' }),
            jsxRuntime.jsx(Yo, {
              colors: A,
              selectedColor: e,
              onSelect: y,
            ...
            p &&
              ...
              jsxRuntime.jsxs('div', {
                style: Oo,
                children: [
                  jsxRuntime.jsx('div', { style: ut, children: 'Custom Color' }),
                  jsxRuntime.jsxs('div', {
                    style: _o,
                    children: [
                      jsxRuntime.jsx('span', {
...
function ui({
  ...
  return jsxRuntime.jsxs('button', {
    ...
    title: o,
    children: [
      n && jsxRuntime.jsx(Uo, { size: a ? 14 : 16 }),
...
function Pi({ onAction: e, disabled: t = false, canMerge: o = false, canSplit: r = false }) {
  let i = nr.useCallback((l) => {
    ...
    g = jsxRuntime.jsx(chunk3BS5FKGU_cjs.i, {
      content: 'Merge cells',
      children: jsxRuntime.jsx(chunk3BS5FKGU_cjs.c, {
        variant: 'ghost',
        size: 'icon-sm',
        className: chunk3BS5FKGU_cjs.a(
        ...
        children: jsxRuntime.jsx(chunk3BS5FKGU_cjs.d, { name: 'call_merge', size: 20 }),
      }),
    }),
    s = jsxRuntime.jsx(chunk3BS5FKGU_cjs.i, {
      content: 'Split cell',
      children: jsxRuntime.jsx(chunk3BS5FKGU_cjs.c, {
        variant: 'ghost',
        size: 'icon-sm',
        ...
        children: jsxRuntime.jsx(chunk3BS5FKGU_cjs.d, { name: 'call_split', size: 20 }),
      }),
    });
  return jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [g, s] });
}
var Go = [
  {
    action: 'addRowAbove',
...
function Fi({ onAction: e, disabled: t = false }) {
  let o = nr.useCallback((r) => {
    (r.preventDefault(), r.stopPropagation());
  }, []);
  return jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: Go.map(({ action: r, icon: i, label: n, testId: a }) =>
      jsxRuntime.jsx(
        chunk3BS5FKGU_cjs.i,
        {
          content: n,
          children: jsxRuntime.jsx(chunk3BS5FKGU_cjs.c, {
            ...
            'aria-label': n,
            'data-testid': a,
            children: jsxRuntime.jsx(chunk3BS5FKGU_cjs.d, { name: i, size: 20 }),
          }),
        },
...
`,
  ...
  Hi = ({
    ...
    let p = () => {
        switch (t) {
          case 'spinner':
            return jsxRuntime.jsx(qo, { size: m.size, strokeWidth: m.strokeWidth, color: s });
          case 'dots':
            return jsxRuntime.jsx(er, { size: m.size, color: s });
          case 'bar':
            return jsxRuntime.jsx(tr, { size: m.size, color: s });
          case 'pulse':
            return jsxRuntime.jsx(or, { size: m.size, color: s });
          case 'progress':
            return jsxRuntime.jsx(rr, {
              size: m.size,
              color: s,
              progress: a,
              showText: g,
...
function Ki() {
  let [e, t] = nr.useState(new Map()),
    o = nr.useCallback((g, s) => {
      t((l) => {
        let f = new Map(l);
        return (f.set(g, { id: g, message: s, startTime: Date.now() }), f);
      });
    }, []),
    r = nr.useCallback((g, s) => {
      t((l) => {
        let f = l.get(g);
        if (!f) return l;
        let m = new Map(l);
...
function cr(e) {
  ...
  let { visibleItems: l, overflowItems: f } = nr.useMemo(() => {
    let m = [...o].sort((p, c) =>
  ...
  Ji = ({
    ...
    return jsxRuntime.jsxs('div', {
      ...
      children: [
        ...
        R && jsxRuntime.jsx('div', { style: { flex: 1, minWidth: 0 } }),
        R &&
          jsxRuntime.jsxs('div', {
            ...
            children: [
              ...
              i
                ? b && i(C, I)
                : jsxRuntime.jsx(dr, { items: C, isOpen: b, onClose: I, anchorRef: h }),
            ],
          }),
      ],
    });
          ...
          children: [
            jsxRuntime.jsx('h2', {
              ...
              children: jsxRuntime.jsxs('span', {
                ...
                children: [jsxRuntime.jsx(Pr, {}), 'Insert Table'],
              }),
            }),
            jsxRuntime.jsx('button', {
              type: 'button',
...
function la() {
  let [e, t] = nr.useState(false),
    o = nr.useCallback(() => t(true), []),
    r = nr.useCallback(() => t(false), []),
    i = nr.useCallback(() => t((n) => !n), []);
...
function ba({
  ...
  let [s, l] = nr.useState(null),
    [f, m] = nr.useState(false),
    [p, c] = nr.useState(0),
    [h, b] = nr.useState(0),
    [d, x] = nr.useState(''),
    [u, v] = nr.useState(true),
    [C, R] = nr.useState(1),
    [H, I] = nr.useState(null),
    A = nr.useRef(null),
    N = nr.useRef(null);
  nr.useEffect(() => {
    e && (l(null), m(false), c(0), b(0), x(''), v(true), R(1), I(null));
  }, [e]);
  let y = nr.useCallback(
      (E) => {
          ...
          children: [
            ...
            jsxRuntime.jsx('div', {
              ...
              children: s
                ? jsxRuntime.jsx('div', {
                    style: Br,
                    children: jsxRuntime.jsx('img', { src: s.src, alt: d || 'Preview', style: zr }),
                  })
                : jsxRuntime.jsxs(jsxRuntime.Fragment, {
                    children: [
                      jsxRuntime.jsx('div', { style: Wr, children: jsxRuntime.jsx(Qr, {}) }),
                      jsxRuntime.jsx('div', {
                        style: Yr,
                        children: 'Click to select or drag and drop an image',
                      }),
                      jsxRuntime.jsx('div', { style: Hr, children: 'PNG, JPG, GIF up to 10MB' }),
                    ],
                  }),
            }),
            s?.fileName &&
                      ...
                      jsxRuntime.jsxs('div', {
                        ...
                        children: [
                          ...
                          jsxRuntime.jsx('button', {
                            ...
                            children: jsxRuntime.jsx(Jr, { locked: u }),
                          }),
                          jsxRuntime.jsx('span', {
                            style: { fontSize: '14px', color: 'var(--doc-text-muted)' },
                            children: 'Height:',
...
function Aa({ isOpen: e, onClose: t, onInsert: o, recentSymbols: r = [], className: i, style: n }) {
  let [a, g] = nr.useState('common'),
    [s, l] = nr.useState(null),
    [f, m] = nr.useState(''),
    [p, c] = nr.useState(null),
    h = nr.useRef(null);
  nr.useEffect(() => {
          ...
          children: [
            ...
            I &&
              jsxRuntime.jsxs('div', {
                ...
                style: mn,
                children: [
                  jsxRuntime.jsx('div', { style: xn, children: I.character }),
                  jsxRuntime.jsxs('div', {
                    style: fn,
                    children: [
                      jsxRuntime.jsx('div', {
...
function Da(e = 20) {
  let [t, o] = nr.useState(false),
    [r, i] = nr.useState([]),
    n = nr.useCallback(() => o(true), []),
    a = nr.useCallback(() => o(false), []),
    g = nr.useCallback(() => o((l) => !l), []),
    s = nr.useCallback(
      (l) => {
        i((f) => {
  ...
  Ua = ({ isOpen: e, onClose: t, onPaste: o, position: r, className: i = '' }) => {
    ...
    (nr.useEffect(() => {
      ...
      (async () => {
        (m(true), c(null));
        try {
          let x = await chunk3BS5FKGU_cjs.oa({ cleanWordFormatting: !0 });
...
function Ka(e = {}) {
  let { onPaste: t, enabled: o = true } = e,
    ...
    g = nr.useCallback(async () => {
      if (!(!o || !t))
        try {
          let l = await chunk3BS5FKGU_cjs.oa({ cleanWordFormatting: !0 });
          l && t(l, !0);
        } catch (l) {
                          ...
                          jsxRuntime.jsxs(
                            'div',
                            {
                              ...
                              children: [
                                ...
                                jsxRuntime.jsx('div', {
                                  children: c.map((h) => jsxRuntime.jsx(In, { shortcut: h }, h.id)),
                                }),
                              ],
                            },
                            p
...
exports.xa = as;
exports.y = vi;
exports.z = Pi; //# sourceMappingURL=chunk-2OAOUACL.cjs.map
//# sourceMappingURL=chunk-2OAOUACL.cjs.map
