...
var A = class r {
  constructor(t) {
    chunkQEBO3EQP_cjs.d(this, '_document');
    chunkQEBO3EQP_cjs.d(this, '_pendingVariables');
  ...
  static async fromBuffer(t) {
    let e = await chunkGILLFIXY_cjs.r(t);
    return new r(e);
  }
  ...
  getVariables() {
    return chunk3V4TBEQV_cjs.a(this._document);
  }
  getStyles() {
  ...
  async applyVariables(t) {
    ...
    let { processTemplate: a } = await import('./processTemplate-RFBGVH7T.cjs'),
      o = a(n, e),
      i = await chunkGILLFIXY_cjs.r(o),
      s = new r(i);
  ...
  executeCommands(t) {
    return new r(chunkGWBTKVFD_cjs.b(this._document, t));
  }
  _executeCommand(t) {
    let e = new r(chunkGWBTKVFD_cjs.a(this._document, t));
...
function N(r, t = {}) {
  let { outlineMaxChars: e = 100, maxOutlineParagraphs: n = 50 } = t,
    ...
    o = a.content.filter((x) => x.type === 'paragraph'),
    i = M(o, e, n),
    s = chunk3V4TBEQV_cjs.a(r),
    c = q(r),
    p = $(a),
    u = U(a),
    h = G(a),
    m = a.content.some((x) => x.type === 'table'),
    y = Q(a),
    l = X(a);
  return {
