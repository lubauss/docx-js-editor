'use strict';
var chunkIHVS6O3T_cjs = require('./chunk-IHVS6O3T.cjs'),
  J = require('react'),
  D = require('@radix-ui/react-select'),
  clsx = require('clsx'),
...
var ye = D__namespace.Root,
  Be = D__namespace.Group,
  ct = D__namespace.Value;
function Ce({ className: e, children: t, onMouseDown: o, ...n }) {
  return jsxRuntime.jsxs(D__namespace.Trigger, {
    className: P(
    ...
    children: [
      t,
      jsxRuntime.jsx(D__namespace.Icon, {
        asChild: true,
        children: jsxRuntime.jsx(Mn, { className: 'h-4 w-4 text-slate-400 shrink-0' }),
      }),
    ],
  });
}
function Te({ className: e, children: t, position: o = 'popper', onCloseAutoFocus: n, ...r }) {
  return jsxRuntime.jsx(D__namespace.Portal, {
    children: jsxRuntime.jsx('div', {
      className: 'ep-root',
      children: jsxRuntime.jsx(D__namespace.Content, {
        className: P(
        ...
        ...r,
        children: jsxRuntime.jsx(D__namespace.Viewport, {
          className: P(
            'p-1',
            o === 'popper' &&
...
function Fe({ className: e, ...t }) {
  return jsxRuntime.jsx(D__namespace.Label, {
    className: P('px-2 py-1.5 text-xs font-medium text-slate-500', e),
    ...t,
  });
}
function ce({ className: e, children: t, onMouseDown: o, ...n }) {
  return jsxRuntime.jsxs(D__namespace.Item, {
    className: P(
    ...
    ...n,
    children: [
      jsxRuntime.jsx(D__namespace.ItemText, { children: t }),
      jsxRuntime.jsx('span', {
        className: 'absolute right-2 flex h-3.5 w-3.5 items-center justify-center',
        children: jsxRuntime.jsx(D__namespace.ItemIndicator, {
          children: jsxRuntime.jsx(kn, { className: 'h-4 w-4' }),
        }),
      }),
    ],
  });
...
function et({ className: e, ...t }) {
  return jsxRuntime.jsx(D__namespace.Separator, {
    className: P('-mx-1 my-1 h-px bg-slate-100', e),
    ...t,
  });
}
  ...
  return jsxRuntime.jsxs(ye, {
    ...
    children: [
      jsxRuntime.jsx(Ce, {
        ...
        children: jsxRuntime.jsx(ct, { placeholder: a, children: d }),
      }),
      jsxRuntime.jsxs(Te, {
        ...
        children: [
          p['sans-serif'].length > 0 &&
            jsxRuntime.jsxs(Be, {
              children: [
                jsxRuntime.jsx(Fe, { children: 'Sans Serif' }),
                p['sans-serif'].map((l) =>
                  jsxRuntime.jsx(
                    ce,
                    {
          ...
          p.serif.length > 0 &&
            jsxRuntime.jsxs(jsxRuntime.Fragment, {
              children: [
                ...
                jsxRuntime.jsxs(Be, {
                  children: [
                    jsxRuntime.jsx(Fe, { children: 'Serif' }),
                    p.serif.map((l) =>
                      jsxRuntime.jsx(
                        ce,
                        {
          ...
          p.monospace.length > 0 &&
            jsxRuntime.jsxs(jsxRuntime.Fragment, {
              children: [
                ...
                jsxRuntime.jsxs(Be, {
                  children: [
                    jsxRuntime.jsx(Fe, { children: 'Monospace' }),
                    p.monospace.map((l) =>
                      jsxRuntime.jsx(
                        ce,
                        {
...
var Zn = co(
  ...
  U = J__namespace.forwardRef(({ className: e, variant: t, size: o, ...n }, r) =>
    jsxRuntime.jsx('button', {
      className: P(Zn({ variant: t, size: o, className: e })),
      ref: r,
      ...n,
    })
  );
...
function vo({
  ...
  let [d, u] = J.useState(false),
    [p, l] = J.useState(''),
    [f, m] = J.useState(false),
    h = J.useRef(null),
    v = J.useCallback(() => {
      (m(false), u(false));
    }, []),
...
function xo(e, t, o) {
  ...
  if (typeof e == 'string') {
    if (t === 'highlight') {
      let n = chunkIHVS6O3T_cjs.b(e);
      return n || (e === 'none' ? 'transparent' : e.startsWith('#') ? e : `#${e}`);
    }
    return e.startsWith('#') ? e : `#${e}`;
  }
  return chunkIHVS6O3T_cjs.a(e, o);
}
function Mi(e) {
  let t = e.replace(/^#/, '');
...
function To(e, t, o) {
  return e
    ? (typeof e == 'string'
        ...
        : chunkIHVS6O3T_cjs.a(e, o).replace(/^#/, '').toUpperCase()) === t.toUpperCase()
    : false;
}
...
function Ee({
  ...
  let S = J.useCallback(() => l(false), []),
    { containerRef: I, dropdownRef: b, dropdownStyle: C } = Y({ isOpen: p, onClose: S }),
    E = n?.colorScheme ?? null,
    R = J.useMemo(() => chunkIHVS6O3T_cjs.p(E), [E]),
    B = J.useMemo(() => xo(t, e, n), [t, e, n]),
    k = J.useCallback(() => {
      r || l((y) => !y);
    }, [r]),
    F = J.useCallback(
      ...
      jsxRuntime.jsxs('button', {
        ...
        children: [
          jsxRuntime.jsxs('div', {
            ...
            children: [
              jsxRuntime.jsx(x, { name: N, size: 18 }),
              jsxRuntime.jsx('div', {
                style: {
                  ...Pi,
        ...
        jsxRuntime.jsx('div', {
          ...
          children: jsxRuntime.jsxs(jsxRuntime.Fragment, {
            children: [
              ...
              jsxRuntime.jsx(ki, { matrix: R, selectedColor: t, theme: n, onSelect: F }),
              jsxRuntime.jsx('div', { style: Et }),
              jsxRuntime.jsx('div', { style: Ht, children: 'Standard Colors' }),
              jsxRuntime.jsx(Ri, { selectedColor: t, theme: n, onSelect: K }),
              jsxRuntime.jsx('div', { style: Et }),
...
function ee({ content: e, children: t, side: o = 'bottom', delayMs: n = 400 }) {
  let [r, a] = J__namespace.useState(false),
    [i, c] = J__namespace.useState({ x: 0, y: 0 }),
    d = J__namespace.useRef(null),
    u = J__namespace.useRef(null),
    p = J__namespace.useCallback(() => {
  ...
  Dt = [
    {
      value: 'left',
      label: 'Align Left',
      icon: jsxRuntime.jsx(x, { name: 'format_align_left', size: nt }),
    ...
    },
    {
      value: 'center',
      label: 'Center',
      icon: jsxRuntime.jsx(x, { name: 'format_align_center', size: nt }),
    ...
    },
    {
      value: 'right',
      label: 'Align Right',
      icon: jsxRuntime.jsx(x, { name: 'format_align_right', size: nt }),
    ...
    },
    {
      value: 'both',
      label: 'Justify',
      icon: jsxRuntime.jsx(x, { name: 'format_align_justify', size: nt }),
...
function Po({ value: e = 'left', onChange: t, disabled: o = false }) {
  let [n, r] = J.useState(false),
    ...
    f = jsxRuntime.jsxs(U, {
      ...
      children: [
        jsxRuntime.jsx(x, { name: l.iconName, size: nt }),
  ...
  return jsxRuntime.jsxs('div', {
    ...
    children: [
      n
        ? f
        : jsxRuntime.jsx(ee, {
            content: `${l.label}${l.shortcut ? ` (${l.shortcut})` : ''}`,
            children: f,
          }),
      n &&
        !o &&
            ...
            children: Dt.map((m) => {
              ...
              return jsxRuntime.jsx(
                'button',
                {
                  ...
                  onClick: () => p(m.value),
                  children: jsxRuntime.jsx(x, { name: m.iconName, size: 18 }),
                },
                m.value
              );
            }),
      ...
      jsxRuntime.jsxs('div', {
        ...
        children: [
          jsxRuntime.jsx(mt, {
            ...
            onClick: t,
            style: l(),
            children: jsxRuntime.jsx(x, { name: 'format_list_bulleted', size: dt }),
          }),
          jsxRuntime.jsx(mt, {
            active: m,
            disabled: a,
            ...
            onClick: o,
            style: l(),
            children: jsxRuntime.jsx(x, { name: 'format_list_numbered', size: dt }),
          }),
        ],
      }),
      d &&
        jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [
            jsxRuntime.jsx('div', { style: zi, role: 'separator' }),
            jsxRuntime.jsxs('div', {
              style: Mo,
              role: 'group',
              ...
              children: [
                jsxRuntime.jsx(mt, {
                  ...
                  onClick: r,
                  style: l(),
                  children: jsxRuntime.jsx(x, { name: 'format_indent_decrease', size: dt }),
                }),
                jsxRuntime.jsx(mt, {
                  active: false,
                  disabled: a,
                  ...
                  onClick: n,
                  style: l(),
                  children: jsxRuntime.jsx(x, { name: 'format_indent_increase', size: dt }),
                }),
              ],
            }),
          ],
  ...
  return jsxRuntime.jsxs(ye, {
    ...
    children: [
      jsxRuntime.jsx(Ce, {
        ...
        children: jsxRuntime.jsx(Lt, { className: 'h-5 w-5 shrink-0' }),
      }),
      jsxRuntime.jsxs(Te, {
        children: [
          o.map((c) =>
            jsxRuntime.jsx(ce, { value: c.twipsValue.toString(), children: c.label }, c.twipsValue)
          ),
          jsxRuntime.jsx(et, {}),
          jsxRuntime.jsx(Be, { children: jsxRuntime.jsx(Fe, { children: 'Paragraph spacing' }) }),
        ],
      }),
    ],
  });
  ...
  return jsxRuntime.jsxs(ye, {
    ...
    children: [
      jsxRuntime.jsx(Ce, {
        ...
        children: jsxRuntime.jsx('span', { className: 'truncate', children: u }),
      }),
      jsxRuntime.jsx(Te, {
        ...
        children: i.map((p) =>
          jsxRuntime.jsx(
            ce,
            {
              ...
              children: jsxRuntime.jsx('span', { style: Gi(p), children: p.name }),
            },
            p.styleId
          )
        ),
  ...
  return jsxRuntime.jsxs(ye, {
    ...
    children: [
      jsxRuntime.jsx(Ce, {
        ...
        'aria-label': `Zoom: ${i}`,
        children: jsxRuntime.jsx(ct, { placeholder: '100%', children: i }),
      }),
      jsxRuntime.jsx(Te, {
        children: o.map((d) =>
          jsxRuntime.jsx(ce, { value: d.value.toString(), children: d.label }, d.value)
        ),
      }),
    ],
  });
...
function qo({ onAction: e, disabled: t = false }) {
  ...
  return jsxRuntime.jsxs('div', {
    ...
    style: { position: 'relative', display: 'inline-block' },
    children: [
      o ? p : jsxRuntime.jsx(ee, { content: 'Borders', children: p }),
      o &&
        !t &&
        jsxRuntime.jsx('div', {
          ref: i,
            ...
            children: Ji.map(({ action: l, icon: f, label: m }) =>
              jsxRuntime.jsx(
                'button',
                {
                  ...
                  onClick: () => u(l),
                  children: jsxRuntime.jsx(x, { name: f, size: 18 }),
                },
...
function Fo({ onAction: e, disabled: t = false }) {
  ...
  return jsxRuntime.jsxs('div', {
    ...
    style: { position: 'relative', display: 'inline-block' },
    children: [
      o ? p : jsxRuntime.jsx(ee, { content: 'Border width', children: p }),
      o &&
        !t &&
        jsxRuntime.jsx('div', {
          ref: i,
            ...
            jsxRuntime.jsxs(
              'button',
              {
                ...
                children: [
                  ...
                  jsxRuntime.jsx('span', { children: f }),
                ],
              },
              l
            )
...
function $o({ onAction: e, disabled: t = false, tableContext: o }) {
        ...
        'button',
        {
          ...
          children: [
            jsxRuntime.jsx(x, {
              name: I,
              size: 16,
              className: E?.danger && !R ? 'text-red-600' : '',
            }),
            jsxRuntime.jsx('span', { style: { flex: 1 }, children: b }),
          ],
        },
        S
      );
  ...
  return jsxRuntime.jsxs('div', {
    ...
    style: { position: 'relative', display: 'inline-block' },
    children: [
      n ? v : jsxRuntime.jsx(ee, { content: 'More table options', children: v }),
      n &&
        !t &&
        jsxRuntime.jsxs('div', {
          ref: u,
          ...
          children: [
            ...
            jsxRuntime.jsx('div', { style: $e, role: 'separator' }),
            ...
            jsxRuntime.jsx('div', { style: $e, role: 'separator' }),
            jsxRuntime.jsx('div', { style: Wo, children: 'Vertical alignment' }),
            jsxRuntime.jsx('div', {
              ...
              children: ['top', 'center', 'bottom'].map((S) => {
                ...
                return jsxRuntime.jsx(
                  'button',
                  {
                    ...
                    children: jsxRuntime.jsx(x, { name: I[S], size: 16 }),
                  },
                  S
                );
              }),
            ...
            jsxRuntime.jsx('div', { style: $e, role: 'separator' }),
            jsxRuntime.jsx('div', { style: Wo, children: 'Table alignment' }),
            jsxRuntime.jsx('div', {
              style: { display: 'flex', gap: 4, padding: '4px 14px' },
...
function Ko({ onInsert: e, gridRows: t = 6, gridColumns: o = 6 }) {
  ...
  return jsxRuntime.jsxs('div', {
    children: [
      ...
      jsxRuntime.jsx('div', { style: ca, children: u }),
    ],
  });
}
function da(e) {
    ...
    children: [
      ...
      n &&
        jsxRuntime.jsx('div', {
          ...
          onMouseDown: (m) => m.preventDefault(),
          children: t.map((m, h) => {
            if (da(m)) return jsxRuntime.jsx('div', { style: ha }, `sep-${h}`);
            let v = m;
            if (v.customContent)
              return jsxRuntime.jsx(
                'div',
              ...
              'div',
              {
                ...
                children: [
                  jsxRuntime.jsxs('button', {
                    ...
                    disabled: v.disabled,
                    children: [
                      v.icon && jsxRuntime.jsx(x, { name: v.icon, size: 18 }),
                      jsxRuntime.jsx('span', { children: v.label }),
                      v.shortcut && jsxRuntime.jsx('span', { style: ga, children: v.shortcut }),
                      S &&
                        jsxRuntime.jsx('span', {
...
function yt({
  ...
  let [d, u] = J.useState(false),
    ...
    S = jsxRuntime.jsxs(U, {
      ...
      'data-testid': c,
      children: [
        jsxRuntime.jsx(x, { name: o, size: xa }),
        jsxRuntime.jsx(x, { name: 'arrow_drop_down', size: 14, className: '-ml-1' }),
      ],
    });
  return jsxRuntime.jsxs('div', {
    ...
    style: { position: 'relative', display: 'inline-block' },
    children: [
      d ? S : jsxRuntime.jsx(ee, { content: n, children: S }),
      d &&
        !a &&
        jsxRuntime.jsx('div', {
          ref: f,
            ...
            children: e.map((I) => {
              ...
              return jsxRuntime.jsx(
                'button',
                {
                  ...
                  onClick: () => v(I.value),
                  children: jsxRuntime.jsx(x, { name: I.iconName, size: 18 }),
                },
                I.value
              );
            }),
...
function re({
  ...
  return o ? jsxRuntime.jsx(ee, { content: o, children: u }) : u;
}
...
function xc({
  ...
  return jsxRuntime.jsxs('div', {
    ...
    children: [
      ...
      S && jsxRuntime.jsx(Po, { value: e.alignment || 'left', onChange: Se, disabled: i }),
      (I || b) &&
        jsxRuntime.jsxs(ge, {
          ...
          children: [
            ...
            b && jsxRuntime.jsx(Zo, { value: e.lineSpacing, onChange: Le, disabled: i }),
          ],
        }),
      Ke &&
        Ye &&
        jsxRuntime.jsxs(ge, {
          label: 'Image',
          children: [
            jsxRuntime.jsx(tn, { imageContext: Ke, onChange: Ye, disabled: i }),
            it && jsxRuntime.jsx(on, { onTransform: it, disabled: i }),
            at &&
              jsxRuntime.jsx(re, {
                onClick: at,
                disabled: i,
      ...
      Pe?.isInTable &&
        ...
        jsxRuntime.jsxs(ge, {
          label: 'Table',
          children: [
            jsxRuntime.jsx(qo, { onAction: Je, disabled: i }),
            jsxRuntime.jsx(Ao, {
              onAction: Je,
              disabled: i,
              theme: R,
              value: Pe?.cellBorderColor
                ? chunkIHVS6O3T_cjs.a(Pe.cellBorderColor, R).replace(/^#/, '')
                : void 0,
            }),
            jsxRuntime.jsx(Fo, { onAction: Je, disabled: i }),
            jsxRuntime.jsx(Oo, {
              onAction: Je,
              disabled: i,
              theme: R,
              value: Pe?.cellBackgroundColor,
            }),
            jsxRuntime.jsx($o, { onAction: Je, disabled: i, tableContext: Pe }),
          ],
        }),
      jsxRuntime.jsx(re, {
...
function wc({
  ...
  let f = J.useMemo(() => (i ? i(e, t) : a ? `Page ${e} of ${t}` : `${e} / ${t}`), [e, t, i, a]),
    m = {
      ...ka,
      ...La[n],
      ...(r ? Ra : {}),
...
function Da() {
  return jsxRuntime.jsx('svg', {
    ...
    children: jsxRuntime.jsx('polyline', { points: '15 18 9 12 15 6' }),
  });
}
function _a() {
  return jsxRuntime.jsx('svg', {
    ...
    strokeLinecap: 'round',
    strokeLinejoin: 'round',
    children: jsxRuntime.jsx('polyline', { points: '9 18 15 12 9 6' }),
  });
}
function Na() {
  return jsxRuntime.jsx('svg', {
    ...
    children: [
      ...
      jsxRuntime.jsxs('div', {
        ...
        children: [
          ...
          jsxRuntime.jsx('button', { onClick: l, style: C, type: 'button', children: 'Go' }),
        ],
      }),
      c && jsxRuntime.jsx('div', { style: E, children: c }),
      jsxRuntime.jsxs('div', {
        style: R,
        children: [
          jsxRuntime.jsx('button', {
...
function _c({
  ...
  let [p, l] = J.useState(false),
    [f, m] = J.useState(false),
    [h, v] = J.useState(false),
    [S, I] = J.useState(false),
    b = J.useRef(null),
    C = e > 1,
    E = e < t,
    R = J.useCallback(() => {
          ...
          jsxRuntime.jsxs('button', {
            ...
            children: [
              jsxRuntime.jsxs('span', {
                children: ['Page ', jsxRuntime.jsx('strong', { children: e }), ' of ', t],
              }),
              p ? jsxRuntime.jsx(Na, {}) : jsxRuntime.jsx(qa, {}),
            ],
          }),
          p &&
            jsxRuntime.jsx(Wa, {
...
function Gc({
  ...
  let [b, C] = J.useState(null),
    ...
    le = chunkIHVS6O3T_cjs.r(z) * t,
    Ke = chunkIHVS6O3T_cjs.r(w) * t,
    Ye = chunkIHVS6O3T_cjs.r(u) * t,
    it = chunkIHVS6O3T_cjs.r(p) * t,
    at = d ? -c : c,
    Pe = chunkIHVS6O3T_cjs.r(at) * t,
    Ae = le + Ye,
    lt = y - Ke - it,
    W = le + Ye + Pe,
    Me = J.useCallback(
    ...
    je = J.useCallback(
      (_) => {
        ...
        K(Se);
        let Re = chunkIHVS6O3T_cjs.s(Se / t);
        if (b === 'leftMargin') {
          let se = M - w - 720,
  ...
  return jsxRuntime.jsxs('div', {
    ...
    children: [
      ...
      jsxRuntime.jsx('div', {
        ...
        onMouseDown: o && r ? (_) => Me(_, 'rightMargin') : void 0,
      }),
      jsxRuntime.jsx('div', {
        style: { position: 'absolute', inset: 0, pointerEvents: 'none' },
        children: Rt.map((_, ke) => jsxRuntime.jsx(Qa, { tick: _ }, ke)),
      }),
      i &&
        jsxRuntime.jsx(Ut, {
          direction: 'down',
      ...
      S?.map((_) =>
        jsxRuntime.jsx(
          ...
          {
            tabStop: _,
            positionPx: chunkIHVS6O3T_cjs.r(_.position) * t,
            onDoubleClick: () => I?.(_.position),
          },
          _.position
        )
      ),
      b && B !== null && F !== null && jsxRuntime.jsx(el, { value: Ja(B, m), positionPx: F }),
    ],
  });
}
function Qa({ tick: e }) {
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [
      jsxRuntime.jsx('div', {
        style: {
          position: 'absolute',
          left: chunkIHVS6O3T_cjs.B(e.position),
          bottom: 0,
          width: 1,
          height: e.height,
          backgroundColor: Ka,
...
function Ut({
  ...
  return jsxRuntime.jsx('div', {
    ...
    tabIndex: o ? 0 : -1,
    children: jsxRuntime.jsx('div', { style: f }),
  });
}
...
function Kc(e, t, o, n) {
  let r = chunkIHVS6O3T_cjs.s(e / n);
  return t === 'left' ? Math.max(0, r) : Math.max(0, chunkIHVS6O3T_cjs.s(o / n) - r);
}
function Yc(e, t = 1) {
  let o = e?.pageWidth ?? sn,
    n = e?.marginLeft ?? Tt,
    r = e?.marginRight ?? Tt,
    a = chunkIHVS6O3T_cjs.r(o) * t,
    i = chunkIHVS6O3T_cjs.r(n) * t,
    c = chunkIHVS6O3T_cjs.r(r) * t;
      ...
      I = () => {
        switch (t) {
          ...
          case 'text':
            return e ? r : a;
          case 'icon':
            return e ? jsxRuntime.jsx(cl, { size: u }) : jsxRuntime.jsx(sl, { size: u });
          default:
            return null;
        }
      };
...
var xe = 16;
function ml() {
  return jsxRuntime.jsx(x, { name: 'table_rows', size: xe, style: { transform: 'scaleY(-1)' } });
}
function fl() {
  return jsxRuntime.jsx(x, { name: 'table_rows', size: xe });
}
function hl() {
  return jsxRuntime.jsx(x, { name: 'view_column', size: xe, style: { transform: 'scaleX(-1)' } });
}
function gl() {
  return jsxRuntime.jsx(x, { name: 'view_column', size: xe });
}
function vl() {
  return jsxRuntime.jsx(x, { name: 'delete_sweep', size: xe });
}
function bl() {
...
function xl() {
  return jsxRuntime.jsx(x, { name: 'call_merge', size: xe });
}
function Sl() {
  return jsxRuntime.jsx(x, { name: 'call_split', size: xe });
}
function yl() {
  return jsxRuntime.jsx(x, { name: 'delete', size: xe, className: 'text-red-600' });
}
var ae = {
  container: {
    display: 'flex',
...
function be({
  ...
  let [d, u] = J__namespace.default.useState(false),
...
exports.x = bc;
exports.y = xc;
exports.z = wc; //# sourceMappingURL=chunk-3BS5FKGU.cjs.map
//# sourceMappingURL=chunk-3BS5FKGU.cjs.map
