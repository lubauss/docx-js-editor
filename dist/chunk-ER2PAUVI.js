import { a, b as b$1 } from './chunk-HSGPG5BL.js';
...
async function Ct(e, t, n) {
  ...
  for (let p of e) {
    ...
    let a = `rId${l}`;
    (c.push(
      `<Relationship Id="${a}" Type="${b$1.hyperlink}" Target="${s(p.href)}" TargetMode="External"/>`
    ),
      (p.rId = a));
  }
  c.length > 0 &&
...
function At(e, t, n, r) {
  ...
  if (e.package.headers)
    for (let [c, p] of e.package.headers.entries()) {
      ...
      let a = i.get(c);
      if (a && a.type === b$1.header && a.target) {
  ...
  if (e.package.footers)
    for (let [c, p] of e.package.footers.entries()) {
      if (l && !l.has(c)) continue;
      let a = i.get(c);
      if (a && a.type === b$1.footer && a.target) {
        let f = a.target.startsWith('/') ? a.target.slice(1) : `word/${a.target}`,
          u = j(p);
        t.file(f, u, { compression: 'DEFLATE', compressionOptions: o });
      }
...
export { ut as a, ht as b, K as c, vt as d, rn as e }; //# sourceMappingURL=chunk-ER2PAUVI.js.map
//# sourceMappingURL=chunk-ER2PAUVI.js.map
