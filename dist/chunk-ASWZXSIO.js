import { e as e$1, i, c, d, a, ia as ia$1 } from './chunk-4HBVK3KZ.js';
import { g, e, f } from './chunk-7JSPKVOW.js';
import { b } from './chunk-CXJ6TLVT.js';
import hr, { useRef, useState, useEffect, useCallback, useMemo, useLayoutEffect } from 'react';
...
var co = ({ action: e$1, onClick: t, isHighlighted: o, onMouseEnter: i }) => {
    let n = e(e$1),
      r = f(e$1),
      a = lo(e$1);
    return jsxs('button', {
  ...
  po = ({ isOpen: e, onSubmit: t, onClose: o, selectedText: i }) => {
    let [n, r] = useState(''),
      a = useRef(null);
    useEffect(() => {
    ...
    let d = (l) => {
        (l.preventDefault(), n.trim() && (t(n.trim()), r('')));
      },
      s = (l) => {
        l.key === 'Escape' && o();
      };
          ...
          children: jsxs('form', {
            ...
            children: [
              jsxs('div', {
                ...
                children: ['Selected: "', i.slice(0, 50), i.length > 50 ? '...' : '', '"'],
              }),
              jsx('input', {
                ref: a,
                type: 'text',
                ...
                children: [
                  ...
                  jsx('button', {
                    ...
                    style: {
                      ...
                      border: 'none',
                      borderRadius: '4px',
                      background: n.trim() ? 'var(--doc-primary)' : 'var(--doc-border)',
                      color: n.trim() ? 'white' : 'var(--doc-text-placeholder)',
  ...
  Kn = ({
        ...
        let c = (b) => {
          switch (b.key) {
            case 'Escape':
              ...
              break;
            case 'ArrowDown':
              (b.preventDefault(), m((P) => (P + 1) % x.length));
              break;
            case 'ArrowUp':
              (b.preventDefault(), m((P) => (P - 1 + x.length) % x.length));
              break;
            case 'Enter':
              b.preventDefault();
              let C = x[h];
              C === 'custom' ? u(true) : (n(C), r());
              break;
          }
        };
        return (
    ...
    let v = useCallback(() => {
        let b = x.length * 36 + 16,
          C = t.x,
          P = t.y;
        return (
          typeof window < 'u' &&
            (C + 200 > window.innerWidth && (C = window.innerWidth - 200 - 10),
            P + b > window.innerHeight && (P = window.innerHeight - b - 10),
            C < 10 && (C = 10),
            P < 10 && (P = 10)),
          {
            position: 'fixed',
    ...
    return !e || !o
      ...
      : jsxs('div', {
          ...
          children: [
            ...
            d && jsx(po, { isOpen: p, onSubmit: f, onClose: () => u(false), selectedText: o }),
          ],
        });
  };
function $n() {
  let [e, t] = useState(false),
    [o, i] = useState({ x: 0, y: 0 }),
    [n, r] = useState(''),
    [a, d] = useState(),
    s = useCallback((h, m, p) => {
      (h.preventDefault(), i({ x: h.clientX, y: h.clientY }), r(m), d(p), t(true));
    }, []),
    l = useCallback(() => {
      t(false);
    }, []);
...
function fo(e, t) {
  let o = [],
    ...
    r = 0,
    a = 0;
  for (; r < i.length || a < n.length; ) {
    if (r >= i.length) {
      o.push({ type: 'added', text: n.slice(a).join('') });
      break;
    }
    if (a >= n.length) {
      o.push({ type: 'removed', text: i.slice(r).join('') });
      break;
    }
    if (i[r] === n[a]) (o.push({ type: 'same', text: i[r] }), r++, a++);
    else {
      let s = n.indexOf(i[r], a),
        l = i.indexOf(n[a], r);
      s === -1 && l === -1
        ? (o.push({ type: 'removed', text: i[r] }), o.push({ type: 'added', text: n[a] }), r++, a++)
        : l !== -1 && (s === -1 || l - r <= s - a)
          ? (o.push({ type: 'added', text: n[a] }), a++)
          : (o.push({ type: 'removed', text: i[r] }), r++);
    }
  }
  let d = [];
  for (let s of o)
...
var ho = ({ original: e, modified: t }) => {
    ...
    return jsx('div', {
      ...
      children: o.map((i, n) => {
        ...
        switch (i.type) {
          case 'removed':
            r = { textDecoration: 'line-through', color: '#d32f2f', backgroundColor: '#ffebee' };
            break;
          case 'added':
            r = { color: '#2e7d32', backgroundColor: '#e8f5e9' };
            break;
        }
        return jsx('span', { style: r, children: i.text }, n);
      }),
    });
  },
  oi = ({
    ...
    (useEffect(() => {
      ...
      useEffect(() => {
        p && g.current && (g.current.focus(), g.current.select());
      }, [p]),
      useEffect(() => {
        let I = (D) => {
          D.key === 'Escape'
            ? p
              ? (u(false), v(c))
              : a()
            : D.key === 'Enter' && (D.metaKey || D.ctrlKey) && (D.preventDefault(), b());
        };
        return (
    ...
    return i
      ? jsx('div', {
          ref: f,
          className: `docx-response-preview docx-response-preview-loading ${h}`,
          style: U,
          children: jsxs('div', {
            style: {
              padding: '24px',
      ...
      : n
        ? jsx('div', {
            ref: f,
            className: `docx-response-preview docx-response-preview-error ${h}`,
            style: U,
            children: jsxs('div', {
              style: { padding: '16px' },
              children: [
        ...
        : !t || !c
          ...
          : jsxs('div', {
              ref: f,
              className: `docx-response-preview ${h}`,
              style: U,
              children: [
                jsxs('div', {
                  style: {
                  ...
                  children: [
                      ...
                      : l
                        ? jsxs('div', {
                            children: [
                              ...
                              jsx(ho, { original: e$1, modified: c }),
                            ],
                          })
                        : jsxs('div', {
                            children: [
                    ...
                    t.warnings &&
                      ...
                      jsx('div', {
                        ...
                        children: t.warnings.map((I, D) => jsx('div', { children: I }, D)),
                      }),
                  ],
                }),
                jsxs('div', {
...
function ri() {
  ...
  return { state: e, showPreview: o, setResponse: i, setError: n, hidePreview: r };
}
function ni(e, t) {
...
var To = ({ item: e, onClick: t, isHighlighted: o, onMouseEnter: i }) =>
    e.action === 'separator'
      ? jsx('div', {
  ...
  di = ({
    ...
    let l = useRef(null),
      ...
      p = (d || mt).map((g) => {
        let f = (() => {
          if (g.disabled !== void 0) return g.disabled;
          switch (g.action) {
            case 'cut':
            case 'copy':
            case 'delete':
      ...
      u = p.filter((g) => g.action !== 'separator');
    (useEffect(() => {
      if (!e) return;
      let g = (c) => {
      ...
      return () => {
        (clearTimeout(f), document.removeEventListener('mousedown', g));
      };
    }, [e, a]),
      useEffect(() => {
        if (!e) return;
          ...
          switch (f.key) {
            ...
            case 'ArrowDown':
              (f.preventDefault(),
                m((b) => {
                  let C = (b + 1) % u.length;
                  for (; u[C]?.disabled && C !== b; ) C = (C + 1) % u.length;
                  return C;
                }));
              break;
            case 'ArrowUp':
              (f.preventDefault(),
                m((b) => {
                  let C = (b - 1 + u.length) % u.length;
                  for (; u[C]?.disabled && C !== b; ) C = (C - 1 + u.length) % u.length;
                  return C;
                }));
              break;
            case 'Enter':
    ...
    let x = useCallback(() => {
        let f = p.length * 36 + 16,
          c = t.x,
          b = t.y;
        return (
          typeof window < 'u' &&
            (c + 220 > window.innerWidth && (c = window.innerWidth - 220 - 10),
            b + f > window.innerHeight && (b = window.innerHeight - f - 10),
            c < 10 && (c = 10),
            b < 10 && (b = 10)),
          {
            position: 'fixed',
...
function pi(e = {}) {
  let { enabled: t = true, isEditable: o = true, containerRef: i, onAction: n } = e,
    [r, a] = useState(false),
    [d, s] = useState({ x: 0, y: 0 }),
    [l, h] = useState(false),
    m = useCallback(() => {
      let g = window.getSelection(),
        f = g && !g.isCollapsed && g.toString().length > 0;
      return (h(!!f), !!f);
    }, []),
    p = useCallback(
      (g) => {
...
var Io = [
  ...
  Lo = { position: 'relative', display: 'inline-block' },
  Ae = {
    display: 'flex',
    alignItems: 'center',
  ...
  Ro = { ...Ae, backgroundColor: 'var(--doc-bg-hover)' },
  Do = { ...Ae, backgroundColor: 'var(--doc-primary-light)', color: 'var(--doc-primary)' },
  Ao = { ...Ae, cursor: 'default', opacity: 0.38 },
  Mo = {
    display: 'flex',
    flexDirection: 'column',
    alignItems: 'center',
  ...
  Oo = { width: '14px', height: '3px', borderRadius: '0', marginTop: '-2px' },
  _o = { display: 'grid', gap: '2px' },
  Me = {
    width: '20px',
    height: '20px',
  ...
  No = { ...Me, transform: 'scale(1.1)', borderColor: '#333', zIndex: 1 },
  Fo = { ...Me, borderWidth: '2px', borderColor: '#0066cc', boxShadow: '0 0 0 1px #0066cc' },
  Bo = { ...Me, position: 'relative', backgroundColor: '#fff' },
  zo = {
    position: 'absolute',
    top: '50%',
    left: '-2px',
  ...
  ft = { fontSize: '11px', color: '#666', marginBottom: '4px', marginTop: '8px' },
  Wo = { marginTop: '8px', paddingTop: '8px', borderTop: '1px solid #eee' },
  Yo = { display: 'flex', alignItems: 'center', gap: '8px' },
  Uo = {
    width: '70px',
    height: '24px',
    padding: '2px 6px',
  ...
  Vo = () => jsx(d, { name: 'format_color_text', size: 18 }),
  Ko = () => jsx(d, { name: 'ink_highlighter', size: 18 }),
  $o = () => jsx(d, { name: 'arrow_drop_down', size: 14 });
function Go({ colors: e, selectedColor: t, onSelect: o, columns: i = 10, cellSize: n = 20 }) {
  let [r, a] = useState(null),
    d = { ..._o, gridTemplateColumns: `repeat(${i}, ${n}px)` };
  return jsx('div', {
    style: d,
    className: 'docx-color-grid',
    role: 'grid',
    children: e.map((s, l) => {
      let h = t?.toUpperCase() === s.hex.toUpperCase(),
        m = r === l,
        p = s.hex === '',
        u = { ...(h ? Fo : m ? No : Me), width: `${n}px`, height: `${n}px` };
      return (
        p || (u.backgroundColor = `#${s.hex}`),
        jsx(
          'button',
          {
            type: 'button',
...
function Si({
  ...
  let [u, x] = useState(false),
    [v, g] = useState(false),
    [f, c] = useState(''),
    b$1 = useCallback(() => x(false), []),
    { containerRef: C, dropdownRef: P, dropdownStyle: U } = e$1({ isOpen: u, onClose: b$1 }),
    I = useMemo(() => {
      if (o === 'highlight') return Po;
      let M = [...Io];
    ...
    H = useCallback(() => {
      let M = f.replace(/^#/, '').toUpperCase();
      /^[0-9A-F]{6}$/i.test(M) && (t?.(M), x(false), c(''));
    }, [f, t]),
    T = useCallback(() => {
      r || x((M) => !M);
    }, [r]),
    L = r ? Ao : u ? Do : v ? Ro : Ae,
    oe = o === 'text' ? 'Font Color' : 'Text Highlight Color';
  return jsxs('div', {
    ref: C,
    ...
    children: [
      ...
      u &&
        jsxs('div', {
          ...
          onMouseDown: (M) => M.preventDefault(),
          children: [
            o === 'highlight' && jsx('div', { style: ft, children: 'Highlight Colors' }),
            jsx(Go, {
              colors: D,
              selectedColor: e,
              onSelect: y,
            ...
            p &&
              ...
              jsxs('div', {
                style: Wo,
                children: [
                  jsx('div', { style: ft, children: 'Custom Color' }),
                  jsxs('div', {
                    style: Yo,
                    children: [
                      ...
                      jsx('input', {
                        ...
                        style: Uo,
                        value: f,
                        onChange: (M) => c(M.target.value.replace(/[^0-9A-Fa-f]/g, '').slice(0, 6)),
                        onKeyDown: (M) => {
                          M.key === 'Enter' && H();
                        },
                        placeholder: 'FF0000',
...
function Ti({
  ...
  return jsxs('button', {
    className: `docx-print-button ${i}`.trim(),
    style: d,
    onClick: e,
    disabled: t,
    'aria-label': o,
    title: o,
    children: [r && jsx(Zo, { size: a ? 14 : 16 }), !a && jsx('span', { children: o })],
  });
}
function Ei() {
  return jsx('style', {
...
function Ri(e, t) {
  ...
  if (/^\d+$/.test(o)) {
    let n = parseInt(o, 10);
    return n >= 1 && n <= t ? { start: n, end: n } : null;
  }
  let i = o.match(/^(\d+)-(\d+)$/);
  if (i) {
    let n = parseInt(i[1], 10),
      r = parseInt(i[2], 10);
    return n >= 1 && r <= t && n <= r ? { start: n, end: r } : null;
  }
  return null;
}
function Di(e, t) {
...
function Yi({ onAction: e, disabled: t = false, canMerge: o = false, canSplit: i$1 = false }) {
  let n = useCallback((l) => {
    ...
    s = jsx(i, {
      ...
      children: jsx(c, {
        ...
        className: a(
          'text-slate-500 hover:text-slate-900 hover:bg-slate-100/80',
          (t || !i$1) && 'opacity-30 cursor-not-allowed'
        ),
        onMouseDown: n,
        onClick: a$1,
        disabled: t || !i$1,
  ...
  return jsxs(Fragment, { children: [d$1, s] });
}
var qo = [
  {
    action: 'addRowAbove',
...
function Xi({ onAction: e, disabled: t = false }) {
  ...
  return jsx(Fragment, {
    children: qo.map(({ action: i$1, icon: n, label: r, testId: a$1 }) =>
      jsx(
        i,
        {
          content: r,
          children: jsx(c, {
            ...
            'aria-label': r,
            'data-testid': a$1,
            children: jsx(d, { name: n, size: 20 }),
          }),
        },
        typeof i$1 == 'string' ? i$1 : i$1.type
      )
    ),
  });
}
var tr = 'var(--doc-error)',
  or = 'var(--doc-success)',
  rr = 'You have unsaved changes. Are you sure you want to leave?',
  nr = ({ size: e = 16 }) =>
    jsxs('svg', {
      width: e,
      height: e,
...
`,
  sr = (e, t, o, i, n, r, a) => {
    let d = {
      ...
      animation: o && i ? 'docx-unsaved-pulse 2s ease-in-out infinite' : 'none',
    };
    switch (
      ...
      case 'text':
        return { ...d, fontSize: '12px', color: o ? n : r, fontWeight: 500 };
      case 'icon':
        return { ...d, color: o ? n : r };
      default:
        return d;
    }
  },
  ta = ({
    ...
    if (
      (useEffect(() => {
        if (!i || !e) return;
        let c = 'docx-unsaved-pulse-keyframes';
        if (!document.getElementById(c)) {
          let b = document.createElement('style');
          ((b.id = c), (b.textContent = ar), document.head.appendChild(b));
        }
      }, [i, e]),
      !e && !a)
    )
      return null;
    let v = { ...sr(t, o, e, i, d, s, l), ...m, cursor: p ? 'pointer' : void 0 },
      g = e ? 'Document has unsaved changes' : 'All changes saved',
      f = () => {
        switch (t) {
          case 'dot':
            return null;
          ...
          case 'text':
            return e ? n : r;
          case 'icon':
            return e ? jsx(ir, { size: l }) : jsx(nr, { size: l });
          default:
            return null;
        }
      };
    return jsx('span', {
      className: `docx-unsaved-indicator docx-unsaved-indicator-${t} ${e ? 'docx-unsaved' : 'docx-saved'} ${h}`,
      style: v,
      onClick: p,
      title: u ?? g,
...
function oa(e = {}) {
  let {
    ...
    x = useCallback((c) => {
      if (!c) return null;
      try {
        return JSON.stringify(c.package);
      } catch {
        return null;
      }
    }, []),
    v = useCallback(() => {
      n && (d(false), l(0), m(t ?? null), (p.current = x(t)));
    }, [n, t, x]),
    g = useCallback(() => {
      n && (a || (d(true), r?.(true)), l((c) => c + 1));
    }, [n, a, r]),
    f = useCallback(
      (c) => {
        let b = c !== void 0 ? c : t;
        (d(false), l(0), m(b ?? null), (p.current = x(b)), (u.current = true));
      },
      [t, x]
    );
  return (
    ...
    useEffect(() => {
      if (!n || !t || !u.current) return;
      let c = x(t),
        b = p.current;
      if (c !== b) {
        let C = x(h);
        (c !== C ? (a || (d(true), r?.(true)), l((P) => P + 1)) : a && (d(false), r?.(false)),
          (p.current = c));
      }
    }, [n, t, h, a, x, r]),
    useEffect(() => {
      if (!n || !o || !a) return;
      let c = (b) => (b.preventDefault(), (b.returnValue = i), i);
      return (
...
`,
  ur = ({ size: e, strokeWidth: t, color: o }) => {
    let i = (e - t) / 2,
      n = i * 2 * Math.PI;
    return jsxs('svg', {
      width: e,
        ...
        jsx(
          'div',
          {
            style: {
              ...
              borderRadius: '50%',
              backgroundColor: t,
              animation: `docx-loading-dots 1.4s ease-in-out ${n * 0.16}s infinite both`,
            },
          },
          n
        )
  ...
  fr = ({ size: e, color: t, progress: o, showText: i, fontSize: n }) => {
    let r = Math.max(0, Math.min(100, o));
    return jsxs('div', {
      style: {
        width: e * 3,
        height: e / 4,
  ...
  pa = ({
    ...
    if (
      (useEffect(() => {
        let x = 'docx-loading-keyframes';
        if (!document.getElementById(x)) {
          let v = document.createElement('style');
          ((v.id = x), (v.textContent = pr), document.head.appendChild(v));
        }
      }, []),
      !e)
    )
    ...
    let p = () => {
        switch (t) {
          case 'spinner':
            return jsx(ur, { size: m.size, strokeWidth: m.strokeWidth, color: s });
          case 'dots':
            return jsx(gr, { size: m.size, color: s });
          case 'bar':
            return jsx(mr, { size: m.size, color: s });
          case 'pulse':
            return jsx(xr, { size: m.size, color: s });
          case 'progress':
            return jsx(fr, {
              size: m.size,
              color: s,
        ...
        children: [
          ...
          i &&
            jsx('div', {
              style: {
                fontSize: m.fontSize,
                color: n ? 'white' : 'var(--doc-text-muted)',
                textAlign: 'center',
              },
              children: i,
            }),
    ...
    return n
      ...
      : jsx('div', {
          ...
          style: { display: 'inline-flex', alignItems: 'center', ...h },
          role: 'progressbar',
          'aria-valuemin': 0,
          'aria-valuemax': 100,
          'aria-valuenow': t === 'progress' ? a : void 0,
...
function ua(e = {}) {
  let { initialLoading: t = false, minDuration: o = dr, onStart: i, onEnd: n } = e,
    [r, a] = useState(t),
    [d, s] = useState(null),
    [l, h] = useState(0),
    m = useRef(null),
    ...
    u = useCallback(
      (g) => {
        ((m.current = Date.now()), a(true), s(g || null), h(0), i?.());
      },
      [i]
    ),
    x = useCallback(() => {
      ...
      b > 0
        ? (p.current = setTimeout(() => {
            (a(false), s(null), h(0), (m.current = null), n?.());
          }, b))
        : (a(false), s(null), h(0), (m.current = null), n?.());
    }, [o, n]),
    v = useCallback(
...
function ga() {
  let [e, t] = useState(new Map()),
    o = useCallback((d, s) => {
      t((l) => {
        let h = new Map(l);
        return (h.set(d, { id: d, message: s, startTime: Date.now() }), h);
      });
    }, []),
    i = useCallback((d, s) => {
      t((l) => {
...
function Sr(e) {
  let { containerRef: t, items: o, itemGap: i = wt, overflowButtonWidth: n = kt } = e,
    [r, a] = useState(o.length),
    d = useRef(new Map()),
    s = useCallback(() => {
      let m = t.current;
      if (!m) {
      ...
      if (p === 0) return;
      let u = [...o].sort((g, f) =>
          g.alwaysVisible && !f.alwaysVisible
            ? -1
            : !g.alwaysVisible && f.alwaysVisible
              ? 1
              : (g.priority || 3) - (f.priority || 3)
        ),
        x = 0,
        v = 0;
      for (let g of u) {
        let c = (g.minWidth || d.current.get(g.id) || yr) + (v > 0 ? i : 0),
          b = v < o.length - 1 ? n + i : 0;
        if (x + c + b <= p) ((x += c), v++);
        else if (g.alwaysVisible) ((x += c), v++);
        else break;
      }
      a(Math.max(0, v));
    }, [t, o, i, n]);
  ...
  let { visibleItems: l, overflowItems: h } = useMemo(() => {
    let m = [...o].sort((p, u) =>
      p.alwaysVisible && !u.alwaysVisible
        ? -1
        : !p.alwaysVisible && u.alwaysVisible
          ? 1
          : (p.priority || 3) - (u.priority || 3)
    );
    return { visibleItems: m.slice(0, r), overflowItems: m.slice(r) };
  }, [o, r]);
  return { visibleItems: l, overflowItems: h, hasOverflow: h.length > 0, recalculate: s };
}
var wr = ({ items: e, isOpen: t, onClose: o, anchorRef: i }) => {
    let n = useRef(null);
    return (
      useEffect(() => {
        if (!t) return;
  ...
  Ca = ({
    ...
    renderOverflowButton: i,
    renderOverflowMenu: n,
    itemGap: r = wt,
    padding: a = '8px 12px',
    overflowButtonWidth: d = kt,
    className: s = '',
    style: l,
    height: h = 44,
    ...
    let u = useRef(null),
      ...
      [v, g] = useState(false),
      {
        ...
        overflowItems: c,
        hasOverflow: b,
      } = Sr({ containerRef: u, items: e, itemGap: r, overflowButtonWidth: d }),
      C = [...c, ...t],
      P = b || o || t.length > 0,
      U = useCallback(() => {
        g((N) => !N);
    ...
    return jsxs('div', {
      ...
      children: [
        ...
        P && jsx('div', { style: { flex: 1, minWidth: 0 } }),
        P &&
          jsxs('div', {
            style: { position: 'relative', flexShrink: 0 },
            children: [
              i ? i(C.length, v, U) : D,
              n ? v && n(C, I) : jsx(wr, { items: C, isOpen: v, onClose: I, anchorRef: x }),
            ],
          }),
      ],
    });
  },
  Sa = ({ children: e, gap: t = 2, separatorAfter: o = false, className: i = '', style: n }) =>
    jsxs(Fragment, {
      children: [
        jsx('div', {
          className: `docx-toolbar-group ${i}`,
          style: { display: 'flex', alignItems: 'center', gap: `${t}px`, ...n },
          children: e,
        }),
        o &&
          jsx('div', {
...
var Er = {
  ...
  Lr = { margin: 0, fontSize: '18px', fontWeight: 600, color: 'var(--doc-text)' },
  Rr = {
    background: 'none',
    border: 'none',
    fontSize: '20px',
  ...
  Dr = { padding: '20px' },
  Ar = { display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '16px' },
  Mr = {
    display: 'grid',
    gap: '2px',
    padding: '4px',
  ...
  Or = { ...Rt, backgroundColor: 'var(--doc-primary)', borderColor: 'var(--doc-primary)' },
  _r = { marginTop: '8px', fontSize: '14px', fontWeight: 500, color: 'var(--doc-text)' },
  Nr = {
    display: 'flex',
    alignItems: 'center',
    gap: '12px',
  ...
  Et = { flex: 1, height: '1px', backgroundColor: 'var(--doc-border)' },
  It = { display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' },
  Pt = { fontSize: '14px', fontWeight: 500, color: 'var(--doc-text)', minWidth: '80px' },
  Lt = {
    width: '80px',
    padding: '8px 12px',
  ...
  Br = { ...Qe, backgroundColor: 'var(--doc-primary)', color: 'white' },
  zr = {
    ...Qe,
    backgroundColor: 'var(--doc-bg-hover)',
    color: 'var(--doc-text)',
...
function Ra({
  ...
  let c = useCallback((T, L) => {
    ...
    C = useCallback(() => {
      let T = Math.min(Math.max(1, u), r),
        L = Math.min(Math.max(1, v), a);
      o({ rows: T, columns: L });
    }, [u, v, r, a, o]),
    P = useCallback(
      (T) => {
    ...
    I = useCallback(
      (T) => {
        ...
        isNaN(L) ? T.target.value === '' && x(1) : x(Math.min(Math.max(1, L), r));
      },
      [r]
    ),
    D = useCallback(
      (T) => {
        let L = parseInt(T.target.value, 10);
        isNaN(L) ? T.target.value === '' && g(1) : g(Math.min(Math.max(1, L), a));
      },
      [a]
    );
  if (!e) return null;
  ...
  let y = u >= 1 && v >= 1,
    H = l > 0 && m > 0 ? `${m} x ${l} Table` : 'Hover to select size';
  return jsx('div', {
            ...
            jsxs('div', {
              ...
              children: [
                jsx('div', {
                  ...
                  style: { ...Mr, gridTemplateColumns: `repeat(${n}, 1fr)` },
                  onMouseLeave: () => {
                    (h(0), p(0));
                  },
                  role: 'grid',
                ...
                jsx('div', { className: 'docx-insert-table-grid-label', style: _r, children: H }),
              ],
            }),
            jsxs('div', {
            ...
            jsxs('div', {
              ...
              children: [
                jsxs('div', {
                  style: It,
                  children: [
                    jsx('label', { htmlFor: 'insert-table-rows', style: Pt, children: 'Rows:' }),
                    jsx('input', {
                ...
                jsxs('div', {
                  style: It,
                  children: [
                    jsx('label', { htmlFor: 'insert-table-cols', style: Pt, children: 'Columns:' }),
                    jsx('input', {
...
function Da() {
  let [e, t] = useState(false),
    ...
    i = useCallback(() => t(false), []),
    n = useCallback(() => t((r) => !r), []);
  return { isOpen: e, open: o, close: i, toggle: n };
}
function Aa(e = 3, t = 3) {
  return { rows: e, columns: t };
}
function Ma(e, t = 100, o = 20) {
  return e.rows >= 1 && e.rows <= t && e.columns >= 1 && e.columns <= o;
}
function Oa(e, t = 100, o = 20) {
...
var Hr = {
  ...
  $r = { margin: 0, fontSize: '18px', fontWeight: 600, color: 'var(--doc-text)' },
  Gr = {
    background: 'none',
    border: 'none',
    fontSize: '20px',
  ...
  Zr = { ...qe, borderColor: 'var(--doc-primary)', backgroundColor: 'var(--doc-primary-light)' },
  Xr = { ...qe, padding: '20px', borderStyle: 'solid', borderColor: 'var(--doc-primary)' },
  Jr = {
    display: 'flex',
    justifyContent: 'center',
    alignItems: 'center',
  ...
  Qr = { maxWidth: '100%', maxHeight: '250px', objectFit: 'contain', borderRadius: '4px' },
  qr = { fontSize: '48px', color: 'var(--doc-text-placeholder)', marginBottom: '12px' },
  en = { fontSize: '14px', color: 'var(--doc-text-muted)', marginBottom: '8px' },
  tn = { fontSize: '12px', color: 'var(--doc-text-placeholder)' },
  At = { marginBottom: '16px' },
  Mt = {
    display: 'block',
    marginBottom: '6px',
    fontSize: '14px',
  ...
  rn = { display: 'flex', alignItems: 'center', gap: '12px' },
  Ot = {
    width: '100px',
    padding: '8px 12px',
    border: '1px solid var(--doc-border-input)',
  ...
  an = { fontSize: '12px', color: 'var(--doc-text-muted)', marginTop: '8px', textAlign: 'center' },
  sn = {
    display: 'flex',
    justifyContent: 'flex-end',
    gap: '12px',
  ...
  ln = { ...et, backgroundColor: 'var(--doc-primary)', color: 'white' },
  cn = {
    ...et,
...
function Ya({
  ...
  let [s, l] = useState(null),
    ...
    N = useRef(null);
  useEffect(() => {
    e && (l(null), m(false), u(0), v(0), f(''), b(true), P(1), I(null));
  }, [e]);
  let y = useCallback(
      (E) => {
          ...
          ((se.onload = () => {
            ...
            if (le > i || ce > n) {
              let Xt = i / le,
                Jt = n / ce,
                st = Math.min(Xt, Jt);
              ((le = Math.round(le * st)), (ce = Math.round(ce * st)));
            }
            (u(le),
              v(ce),
              P(se.width / se.height),
              l({ src: at, width: le, height: ce, fileName: E.name, mimeType: E.type }));
          }),
            (se.src = at));
        }),
          (W.onerror = () => {
    ...
    Vt = useCallback(
      (E) => {
        let W = parseInt(E.target.value, 10) || 0;
        (v(W), c && C && u(Math.round(W * C)));
      },
      [c, C]
    ),
    Ue = useCallback(() => {
      s && o({ ...s, width: p, height: x, alt: g || void 0 });
    }, [s, p, x, g, o]),
    Kt = useCallback(
      (E) => {
        E.key === 'Escape'
          ? t()
          : E.key === 'Enter' && s && !E.shiftKey && (E.preventDefault(), Ue());
      },
      [t, s, Ue]
    ),
    $t = useCallback(
    ...
    Gt = useCallback(() => {
      (l(null), u(0), v(0), f(''), I(null), D.current && (D.current.value = ''));
    }, []);
  if (!e) return null;
  let it = s !== null && p > 0 && x > 0,
    jt = () => (s ? Xr : h ? Zr : qe);
  return jsx('div', {
    ...
    children: jsxs('div', {
      ...
      children: [
        jsxs('div', {
          ...
          style: Kr,
          children: [
            jsx('h2', { id: 'insert-image-dialog-title', style: $r, children: 'Insert Image' }),
            jsx('button', {
              type: 'button',
          ...
          children: [
            ...
            jsx('div', {
              ...
              children: s
                ? jsx('div', {
                    style: Jr,
                    children: jsx('img', { src: s.src, alt: g || 'Preview', style: Qr }),
                  })
                : jsxs(Fragment, {
                    children: [
                      jsx('div', { style: qr, children: jsx(pn, {}) }),
                      jsx('div', {
                        style: en,
                        children: 'Click to select or drag and drop an image',
                      }),
                      jsx('div', { style: tn, children: 'PNG, JPG, GIF up to 10MB' }),
                    ],
                  }),
            }),
            s?.fileName &&
              ...
              jsxs(Fragment, {
                children: [
                  jsxs('div', {
                    style: At,
                    children: [
                      jsx('label', { style: Mt, children: 'Dimensions' }),
                      jsxs('div', {
                        style: rn,
                        children: [
                          jsx('span', {
                          ...
                          jsx('button', {
                            ...
                            onClick: () => b(!c),
                            style: c ? nn : Nt,
                            title: c ? 'Aspect ratio locked' : 'Aspect ratio unlocked',
                            children: jsx(un, { locked: c }),
                          }),
                          jsx('span', {
                            style: { fontSize: '14px', color: 'var(--doc-text-muted)' },
                            children: 'Height:',
...
function $a(e, t, o, i) {
  if (e <= o && t <= i) return { width: e, height: t };
  let n = o / e,
    r = i / t,
    a = Math.min(n, r);
...
var fn = {
  ...
  vn = { margin: 0, fontSize: '18px', fontWeight: 600, color: 'var(--doc-text)' },
  yn = {
    background: 'none',
    border: 'none',
    fontSize: '20px',
  ...
  Cn = { padding: '20px', flex: 1, overflow: 'auto' },
  Sn = {
    width: '100%',
    padding: '10px 12px',
    border: '1px solid var(--doc-border-input)',
  ...
  wn = { display: 'flex', flexWrap: 'wrap', gap: '4px', marginBottom: '16px' },
  Ft = {
    padding: '6px 12px',
    border: '1px solid var(--doc-border-input)',
    borderRadius: '4px',
  ...
  Dn = { ...tt, backgroundColor: 'var(--doc-primary)', color: 'white' },
  An = {
    ...tt,
    backgroundColor: 'var(--doc-bg-subtle)',
    color: 'var(--doc-text)',
...
function Bt() {
  return ke.flatMap((e) => e.symbols);
}
function es({ isOpen: e, onClose: t, onInsert: o, recentSymbols: i = [], className: n, style: r }) {
  let [a, d] = useState('common'),
    [s, l] = useState(null),
    [h, m] = useState(''),
    [p, u] = useState(null),
    x = useRef(null);
  useEffect(() => {
    e && (l(null), m(''), u(null), setTimeout(() => x.current?.focus(), 100));
  }, [e]);
  let v = useMemo(() => {
      if (!h.trim()) return a === 'recent' ? i : ke.find((L) => L.name === a)?.symbols || [];
      let y = h.toLowerCase();
      return Bt().filter((T) => {
    ...
    b = useCallback(
      (y) => {
        y.key === 'Escape' ? t() : y.key === 'Enter' && s && (y.preventDefault(), c());
      },
      [t, s, c]
    ),
    C = useCallback(
    ...
    P = (y) => {
      if (!y) return null;
      let H = y.codePointAt(0);
      return {
        character: y,
        codePoint: H ? `U+${H.toString(16).toUpperCase().padStart(4, '0')}` : '',
        decimal: H || 0,
      };
    };
  if (!e) return null;
  let I = P(p || s),
    D = s !== null,
    N = [
      ...(i.length > 0 ? [{ name: 'recent', label: 'Recent' }] : []),
      ...ke.map((y) => ({ name: y.name, label: y.label })),
    ];
  return jsx('div', {
    className: `docx-insert-symbol-dialog-overlay ${n || ''}`,
    style: { ...fn, ...r },
    onClick: C,
    onKeyDown: b,
    role: 'dialog',
    ...
    children: jsxs('div', {
      ...
      children: [
        jsxs('div', {
          ...
          style: bn,
          children: [
            jsx('h2', { id: 'insert-symbol-dialog-title', style: vn, children: 'Insert Symbol' }),
            jsx('button', {
              type: 'button',
          ...
          children: [
            ...
            v.length === 0 &&
              jsxs('div', {
                ...
                children: ['No symbols found for "', h, '"'],
              }),
            I &&
              jsxs('div', {
                ...
                style: In,
                children: [
                  jsx('div', { style: Pn, children: I.character }),
                  jsxs('div', {
                    style: Ln,
                    children: [
                      jsx('div', {
...
function ts(e = 20) {
  let [t, o] = useState(false),
    [i, n] = useState([]),
    r = useCallback(() => o(true), []),
    a = useCallback(() => o(false), []),
    d = useCallback(() => o((l) => !l), []),
    s = useCallback(
      (l) => {
        n((h) => {
          let m = h.filter((p) => p !== l);
          return [l, ...m].slice(0, e);
        });
      },
      [e]
    );
  return { isOpen: t, recentSymbols: i, open: r, close: a, toggle: d, addRecent: s };
}
function os() {
  return ke;
}
function rs(e) {
  return ke.find((o) => o.name === e)?.symbols || [];
}
function ns(e) {
...
function is(e) {
  ...
  let t = e.toLowerCase();
  return Bt().filter((o) => {
    let i = o.codePointAt(0)?.toString(16).toUpperCase() || '';
    return o.includes(e) || i.includes(t.toUpperCase()) || `U+${i}`.toLowerCase().includes(t);
  });
}
function as(e) {
...
var Bn = ({ option: e, isSelected: t, onClick: o, onMouseEnter: i }) =>
    jsxs('button', {
      type: 'button',
  ...
  us = ({ isOpen: e, onClose: t, onPaste: o, position: i, className: n = '' }) => {
    let r = useRef(null),
      [a, d] = useState(0),
      [s, l] = useState(null),
      [h, m] = useState(false),
    ...
    (useEffect(() => {
      ...
      (async () => {
        (m(true), u(null));
        try {
          let f = await ia$1({ cleanWordFormatting: !0 });
          (l(f), f || u('No content available to paste'));
        } catch {
      ...
      useEffect(() => {
        if (!e) return;
        let g = (f) => {
          r.current && !r.current.contains(f.target) && t();
        };
        return (
          document.addEventListener('mousedown', g),
        ...
        let g = (f) => {
          switch (f.key) {
            case 'Escape':
              ...
              break;
            case 'ArrowDown':
              (f.preventDefault(), d((c) => (c + 1) % ie.length));
              break;
            case 'ArrowUp':
              (f.preventDefault(), d((c) => (c - 1 + ie.length) % ie.length));
              break;
            case 'Enter':
              (f.preventDefault(), x(ie[a].id));
              break;
          }
        };
        return (
    ...
    let x = useCallback(
      ...
      v = useCallback(() => {
        let c = i?.x ?? (typeof window < 'u' ? window.innerWidth / 2 - 160 : 100),
          b = i?.y ?? (typeof window < 'u' ? window.innerHeight / 2 - 200 / 2 : 100);
        return (
          typeof window < 'u' &&
            (c + 320 > window.innerWidth && (c = window.innerWidth - 320 - 10),
            b + 200 > window.innerHeight && (b = window.innerHeight - 200 - 10),
            c < 10 && (c = 10),
            b < 10 && (b = 10)),
          {
            position: 'fixed',
    ...
    return e
      ? jsxs('div', {
          ref: r,
          className: `docx-paste-special-dialog ${n}`,
          style: v(),
          role: 'dialog',
...
function gs(e = {}) {
  let { onPaste: t, enabled: o = true } = e,
    ...
    d = useCallback(async () => {
      if (!(!o || !t))
        try {
          let l = await ia$1({ cleanWordFormatting: !0 });
          l && t(l, !0);
        } catch (l) {
    ...
    s = useCallback(
      (l) =>
        o && (l.ctrlKey || l.metaKey) && l.shiftKey && l.key.toLowerCase() === 'v'
          ? (l.preventDefault(), r(), true)
          : false,
      [o, r]
    );
  return { isOpen: i, openDialog: r, closeDialog: a, handleKeyDown: s, pasteAsPlainText: d };
}
function ms(e) {
...
var Yt = {
  ...
  Ut = ['file', 'editing', 'clipboard', 'formatting', 'selection', 'navigation', 'view', 'other'],
  Ye = [
    {
      id: 'save',
      name: 'Save',
      ...
      h = useMemo(() => {
        ...
        return l.filter(
          (u) =>
            ...
            u.description.toLowerCase().includes(p) ||
            u.keys.toLowerCase().includes(p) ||
            (u.altKeys && u.altKeys.toLowerCase().includes(p))
        );
      }, [l, d]),
      m = useMemo(() => {
        let p = new Map();
        for (let x of h) {
          let v = p.get(x.category) || [];
          (v.push(x), p.set(x.category, v));
        }
        let u = [];
        for (let x of Ut) {
          let v = p.get(x);
          v && v.length > 0 && u.push({ category: x, shortcuts: v });
        }
        return u;
      }, [h]);
    return (
      useEffect(() => {
        e && i && a.current && setTimeout(() => a.current?.focus(), 0);
      }, [e, i]),
      useEffect(() => {
        e || s('');
      }, [e]),
      useEffect(() => {
        if (!e) return;
        let p = (u) => {
          r.current && !r.current.contains(u.target) && t();
        };
        return (
      ...
      e
        ? jsx('div', {
            ...
            children: jsxs('div', {
              ref: r,
              className: `docx-shortcuts-dialog ${n}`,
              style: {
                width: '600px',
                maxWidth: '90vw',
                maxHeight: '80vh',
                          ...
                          jsxs(
                            'div',
                            {
                              ...
                              children: [
                                ...
                                jsx('div', {
                                  children: u.map((x) => jsx(Wn, { shortcut: x }, x.id)),
                                }),
                              ],
                            },
                            p
...
function ws(e = {}) {
  ...
  return (
    ...
    { isOpen: i, open: r, close: a, toggle: d, handleKeyDown: s }
  );
}
function ks() {
  return [...Ye];
...
function Ts(e) {
  return Ye.filter((t) => t.category === e);
}
function Es() {
  return Ye.filter((e) => e.common);
}
function Is(e) {
  return Yt[e];
}
...
export {
  ...
  Yi as z,
  Ts as za,
}; //# sourceMappingURL=chunk-ASWZXSIO.js.map
//# sourceMappingURL=chunk-ASWZXSIO.js.map
