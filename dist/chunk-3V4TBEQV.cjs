...
Variable names should follow the pattern: letters, numbers, underscores, starting with a letter.`,
    ...
    handler: async (e, t) => {
      ...
      try {
        let { executeCommand: i } = await import('./executor-XIPIU3H4.cjs'),
...
Use docx_get_variables first to discover what variables exist in the document.`,
    ...
    handler: async (e, t) => {
      ...
      try {
        let i = chunk4QT5LPBA_cjs.b(o.buffer, a, { nullGetter: r ? 'keep' : 'empty' }),
          s = await chunkGILLFIXY_cjs.r(i.buffer);
        return (
          (o.document = s),
          (o.buffer = i.buffer),
          (o.lastModified = Date.now()),
...
Returns validation result with any errors found and list of valid tags.`,
    ...
    handler: async (e, t) => {
      ...
      try {
        let r = chunk4QT5LPBA_cjs.f(a.buffer);
        return {
          content: [
            {
              type: 'text',
...
exports.m = ee;
exports.n = Z;
exports.o = W; //# sourceMappingURL=chunk-3V4TBEQV.cjs.map
//# sourceMappingURL=chunk-3V4TBEQV.cjs.map
