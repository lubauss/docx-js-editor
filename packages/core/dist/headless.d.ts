export {
  ...
  k as buildSelectionContextFromContext,
  l as colorsEqual,
  m as createAgent,
  n as createAgentFromDocument,
  o as createDocumentWithText,
  p as createDocx,
  q as createEmptyDocument,
  r as createRgbColor,
  s as createTemplateProcessor,
  ...
  R as getMissingVariables,
  U as getSelectionFormattingSummary,
  ...
  a7 as previewTemplate,
  a8 as processTemplate,
  a9 as processTemplateAdvanced,
...
export {
  ...
  m as CommandResult,
  C as CorePlugin,
  n as DEFAULT_AI_ACTIONS,
  o as DeleteTextCommand,
  p as Document,
  q as DocxPackage,
  E as Endnote,
  F as Footnote,
  r as FormatParagraphCommand,
  ...
  O as ToolResult,
  ac as ZodSchemaLike,
  ad as comparePositions,
  ae as createCollapsedRange,
  af as createCommand,
  ag as createRange,
  ah as getActionDescription,
  ai as getActionLabel,
  aj as isPositionInRange,
  ak as isZodSchema,
} from './types-BmzqJw_z.js';
export {
  P as PluginRegistry,
