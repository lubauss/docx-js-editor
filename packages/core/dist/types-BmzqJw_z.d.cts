...
export { type RunContent as $, type AIAction as A, type BlockContent as B, type CorePlugin as C, type DocumentBody as D, type Endnote as E, type Footnote as F, type McpToolContent as G, type Hyperlink as H, type Image as I, type JsonSchema as J, type McpToolContext as K, type ListLevel as L, type McpToolDefinition as M, type McpToolHandler as N, type McpToolResult as O, type PluginOptions as P, type NumberingDefinitions as Q, type Run as R, type ParagraphContext as S, type TextFormatting as T, type ParagraphFormatting as U, type ParagraphOutline as V, type PluginCommand as W, type PluginEvent as X, type Range as Y, type Relationship as Z, type ReplaceTextCommand as _, type PluginRegistrationResult as a, type SectionInfo as a0, type SectionProperties as a1, type SelectionContext as a2, type SetVariableCommand as a3, type Style as a4, type StyleDefinitions as a5, type StyleInfo as a6, type SuggestedAction as a7, type TableCell as a8, type TableRow as a9, type McpToolExample as aA, type TypedCommandHandler as aB, type TextContent as aa, type Theme as ab, type ZodSchemaLike as ac, comparePositions as ad, createCollapsedRange as ae, createCommand as af, createRange as ag, getActionDescription as ah, getActionLabel as ai, isPositionInRange as aj, isZodSchema as ak, type BreakContent as al, type BookmarkEnd as am, type BookmarkStart as an, type Field as ao, type FooterReference as ap, type HeaderFooter as aq, type HeaderReference as ar, type Shape as as, type TextBox as at, type ThemeColorScheme as au, type ThemeFont as av, type ThemeFontScheme as aw, type ThemeColorSlot as ax, type ColorValue as ay, type ExtractCommand as az, type CommandHandler as b, type PluginEventListener as c, type Paragraph as d, type Table as e, type Position as f, type AIActionRequest as g, type AgentCommand as h, type AgentContext as i, type AgentResponse as j, type ApplyStyleCommand as k, type ApplyVariablesCommand as l, type CommandResult as m, DEFAULT_AI_ACTIONS as n, type DeleteTextCommand as o, type Document as p, type DocxPackage as q, type FormatParagraphCommand as r, type FormatTextCommand as s, type InsertHyperlinkCommand as t, type InsertImageCommand as u, type InsertTableCommand as v, type InsertTextCommand as w, type LoadedDocument as x, type McpSession as y, type McpToolAnnotations as z };
