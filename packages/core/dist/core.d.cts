export { A as AgentContextOptions, C as CreateEmptyDocumentOptions, D as DocumentAgent, ap as DocxInput, E as ExtendedSelectionContext, P as ProcessTemplateOptions, e as ProcessTemplateResult, f as SelectionContextOptions, aq as ThemeMatrixCell, V as VariableDetectionResult, g as VariableOccurrence, h as blendColors, i as buildExtendedSelectionContext, j as buildSelectionContext, l as colorsEqual, o as createDocumentWithText, p as createDocx, q as createEmptyDocument, r as createRgbColor, t as createThemeColor, u as darkenColor, v as detectVariables, w as detectVariablesDetailed, x as detectVariablesInBody, y as detectVariablesInParagraph, z as documentHasVariables, B as emuToPixels, G as emuToTwips, ar as ensureHexPrefix, H as executeCommand, J as executeCommands, K as extractVariablesFromText, L as formatPx, M as formatVariable, as as generateThemeTintShadeMatrix, N as getAgentContext, O as getContrastingColor, Q as getDocumentSummary, W as getTemplateTags, at as getThemeTintShadeHex, X as halfPointsToPixels, Y as hasTemplateVariables, Z as isBlack, _ as isValidVariableName, $ as isWhite, a0 as lightenColor, a1 as parseColorString, a2 as parseDocx, a3 as parseVariable, a4 as pixelsToEmu, a5 as pixelsToTwips, a6 as pointsToPixels, a8 as processTemplate, aa as processTemplateAsBlob, ab as processTemplateDetailed, ac as removeVariables, ad as repackDocx, ae as replaceVariables, af as resolveColor, ag as resolveHighlightColor, au as resolveHighlightToCss, ah as resolveShadingColor, ai as sanitizeVariableName, aj as serializeDocumentBody, ak as serializeDocx, al as serializeSectionProperties, av as toArrayBuffer, am as twipsToEmu, an as twipsToPixels, ao as validateTemplate } from './variableDetector-Dbj2_mIx.cjs';
import { p as Document, al as BreakContent, d as Paragraph, R as Run, $ as RunContent, e as Table } from './types-BmzqJw_z.cjs';
export { A as AIAction, g as AIActionRequest, h as AgentCommand, i as AgentContext, j as AgentResponse, k as ApplyStyleCommand, B as BlockContent, am as BookmarkEnd, an as BookmarkStart, C as CorePlugin, o as DeleteTextCommand, D as DocumentBody, q as DocxPackage, E as Endnote, ao as Field, ap as FooterReference, F as Footnote, s as FormatTextCommand, aq as HeaderFooter, ar as HeaderReference, H as Hyperlink, I as Image, t as InsertHyperlinkCommand, u as InsertImageCommand, v as InsertTableCommand, w as InsertTextCommand, L as ListLevel, y as McpSession, M as McpToolDefinition, N as McpToolHandler, O as McpToolResult, Q as NumberingDefinitions, S as ParagraphContext, U as ParagraphFormatting, f as Position, Y as Range, Z as Relationship, _ as ReplaceTextCommand, a1 as SectionProperties, a2 as SelectionContext, a3 as SetVariableCommand, as as Shape, a4 as Style, a5 as StyleDefinitions, a7 as SuggestedAction, a8 as TableCell, a9 as TableRow, at as TextBox, aa as TextContent, T as TextFormatting, ab as Theme, au as ThemeColorScheme, av as ThemeFont, aw as ThemeFontScheme } from './types-BmzqJw_z.cjs';
import { Plugin } from 'prosemirror-state';
import { EditorView } from 'prosemirror-view';
import { Node } from 'prosemirror-model';
export { P as PluginRegistry, p as pluginRegistry, r as registerPlugins } from './registry-CQEFMXeb.cjs';
