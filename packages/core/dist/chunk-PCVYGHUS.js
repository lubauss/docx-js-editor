import { a as a$1 } from './chunk-RZSO673D.js';
import B from 'jszip';
function a(e) {
  return e
    .replace(/&/g, '&amp;')
...
function y(e) {
  let t = [],
    n = pe(e.formatting, e.propertyChanges);
  n && t.push(n);
...
function H(e, t) {
  ...
  return (
    t && t.length > 0 && n.push(...t.map((r) => Be(r))),
...
function U(e, t) {
  ...
  return (
    t && t.length > 0 && n.push(...t.map((r) => We(r))),
...
function Z(e, t, n) {
  ...
  return (
    ...
    t && t.length > 0 && r.push(...t.map((i) => Ge(i))),
...
function Y(e, t, n) {
  ...
  return (
    ...
    t && t.length > 0 && r.push(...t.map((i) => Ze(i))),
...
function Je(e) {
  ...
  return (n && t.push(n), t.push(qe(e.content)), `<w:tc>${t.join('')}</w:tc>`);
}
function Ke(e) {
  let t = [],
    n = Z(e.formatting, e.propertyChanges, e.structuralChange);
  n && t.push(n);
  for (let r of e.cells) t.push(Je(r));
...
function S(e) {
  ...
  n && t.push(n);
  let r = Ye(e.columnWidths);
  r && t.push(r);
  for (let i of e.rows) t.push(Ke(i));
...
function pt(e) {
  if (!e) return '';
  let t = [];
  if (e.headerReferences) for (let f of e.headerReferences) t.push(et(f));
  if (e.footerReferences) for (let f of e.footerReferences) t.push(tt(f));
  let n = nt(e.footnotePr);
  n && t.push(n);
  let r = rt(e.endnotePr);
...
function ut(e) {
  ...
  return (
    t.push(ft(e.content)),
    e.finalSectionProperties && t.push(pt(e.finalSectionProperties)),
    t.join('')
  );
}
function J(e) {
...
function K(e) {
  ...
  if (e.content && e.content.length > 0) {
    n += gt(e.content[0]);
    for (let r = 1; r < e.content.length; r++) n += wt(e.content[r]);
  } else
    n +=
...
async function yt(e, t, n) {
  ...
  (t.file('word/comments.xml', i, { compression: 'DEFLATE', compressionOptions: { level: n } }),
    await Promise.all([Ft(t, n), St(t, n)]));
}
function te(e) {
  let t = [];
  for (let n of e)
...
function $t(e) {
  ...
  return { data: r.buffer, extension: xt[t[1]] || 'png' };
}
async function Tt(e, t, n) {
  ...
  let p = [],
    c = new Set();
  for (let f of e) {
    let { data: m, extension: u } = $t(f.src);
    (s++, l++);
    let h = `image${s}.${u}`,
      g = `word/media/${h}`,
      F = `rId${l}`;
...
async function Pt(e, t, n) {
  ...
  for (let p of e) {
    ...
    let c = `rId${l}`;
    (s.push(
      `<Relationship Id="${c}" Type="${a$1.hyperlink}" Target="${a(p.href)}" TargetMode="External"/>`
    ),
      (p.rId = c));
  }
  s.length > 0 &&
...
async function bt(e, t = {}) {
  ...
  let { compressionLevel: n = 6, updateModifiedDate: r = true, modifiedBy: i } = t,
    o = e,
    l = await B.loadAsync(e.originalBuffer),
    s = new B();
  ...
  if (
    ...
    if (h) {
      let g = await h.async('text'),
        F = zt(g, { updateModifiedDate: r, modifiedBy: i });
...
var vt = 'application/vnd.openxmlformats-officedocument.wordprocessingml.comments+xml',
  Ct = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/comments';
async function Ft(e, t) {
  ...
  r.includes('/word/comments.xml') ||
    ((r = r.replace(
      '</Types>',
      `<Override PartName="/word/comments.xml" ContentType="${vt}"/></Types>`
    )),
...
async function St(e, t) {
  ...
  ((i = i.replace(
    '</Relationships>',
    `<Relationship Id="${o}" Type="${Ct}" Target="comments.xml"/></Relationships>`
  )),
...
function Rt(e, t, n) {
  ...
  if (e.package.headers)
    for (let [o, l] of e.package.headers.entries()) {
      let s = r.get(o);
      if (s && s.type === a$1.header && s.target) {
  ...
  if (e.package.footers)
    for (let [o, l] of e.package.footers.entries()) {
      let s = r.get(o);
      if (s && s.type === a$1.footer && s.target) {
        let p = s.target.startsWith('/') ? s.target.slice(1) : `word/${s.target}`,
          c = I(l);
        t.file(p, c, { compression: 'DEFLATE', compressionOptions: i });
      }
...
export { pt as a, ut as b, J as c, bt as d, nn as e }; //# sourceMappingURL=chunk-PCVYGHUS.js.map
//# sourceMappingURL=chunk-PCVYGHUS.js.map
