...
export { l as parseDocx } from './chunk-RZSO673D.js';
export {
...
function He(t) {
  let e = 0;
  for (let n of t.content)
    n.type === 'paragraph' ? (e += u(p(n))) : n.type === 'table' && (e += Ve(n));
  return e;
}
function Ve(t) {
  let e = 0;
...
function Ee(t) {
  let e = 0;
  for (let n of t.content)
    n.type === 'paragraph' ? (e += p(n).length) : n.type === 'table' && (e += ve(n));
  return e;
}
function ve(t) {
  let e = 0;
...
var et = ['askAI', 'rewrite', 'expand', 'summarize', 'translate', 'explain'];
function tt(t) {
  return { ...t, id: nt() };
}
function nt() {
...
var at = '0.0.2';
export {
  et as DEFAULT_AI_ACTIONS,
  at as VERSION,
  Qe as comparePositions,
  we as countCharacters,
  u as countWords,
  $e as createCollapsedRange,
  tt as createCommand,
  Je as createRange,
  Ye as getActionDescription,
  Xe as getActionLabel,
  Ze as getBlockIndexForParagraph,
  Ee as getBodyCharacterCount,
  Fe as getBodyText,
  He as getBodyWordCount,
  Me as getFormattingAtPosition,
  je as getHyperlinkAtPosition,
  g as getHyperlinkText,
  Ue as getParagraphAtIndex,
  ...
  Ne as hasImages,
  Ge as hasTables,
  qe as isHeadingStyle,
  ze as isPositionInHyperlink,
  Ke as isPositionInRange,
  We as parseHeadingLevel,
