export {
  ...
  C as createRgbColor,
  B as createThemeColor,
  D as darkenColor,
  n as emuToPixels,
  p as emuToTwips,
  G as ensureHexPrefix,
  t as formatPx,
  J as generateThemeTintShadeMatrix,
  f as getAgentContext,
  z as getContrastingColor,
  h as getDocumentSummary,
  I as getThemeTintShadeHex,
  s as halfPointsToPixels,
  x as isBlack,
  y as isWhite,
  E as lightenColor,
  A as parseColorString,
  o as pixelsToEmu,
  m as pixelsToTwips,
  r as pointsToPixels,
  u as resolveColor,
  v as resolveHighlightColor,
  H as resolveHighlightToCss,
  w as resolveShadingColor,
  q as twipsToEmu,
  l as twipsToPixels,
} from './chunk-7MS7BADP.js';
export {
...
export {
  ...
  e as isFontsLoading,
  b as loadFont,
  i as loadFontFromBuffer,
  c as loadFonts,
  g as onFontsLoaded,
  l as parseDocx,
  j as preloadCommonFonts,
  k as toArrayBuffer,
} from './chunk-RZSO673D.js';
export {
...
var u = class {
  constructor(n) {
    ...
    a(this, 'getSnapshot', () => this.snapshot);
    this.snapshot = n;
  }
  setSnapshot(n) {
...
function Rt(t) {
  try {
    ...
    return !n || typeof n != 'object' || !n.document || !n.savedAt
      ? null
      : (n.version !== P && console.warn('Auto-save data version mismatch, may need migration'), n);
  } catch {
    return null;
  }
}
...
var h = class extends u {
  constructor(e = {}) {
    ...
    a(this, 'maxAge');
    a(this, 'saveOnChange');
    a(this, 'debounceDelay');
    a(this, 'onSaveCallback');
    a(this, 'onErrorCallback');
    a(this, 'onRecoveryAvailableCallback');
    a(this, 'storageAvailable');
    a(this, 'currentDocument', null);
    a(this, 'lastSavedJson', null);
    a(this, 'intervalTimer', null);
    a(this, 'debounceTimer', null);
    a(this, 'status', 'idle');
    a(this, 'lastSaveTime', null);
    a(this, '_hasRecoveryData', false);
    a(this, '_isEnabled');
    ((this.storageKey = e.storageKey ?? A),
      (this.interval = e.interval ?? Tt),
      (this.maxAge = e.maxAge ?? Dt),
      (this.saveOnChange = e.saveOnChange ?? true),
      (this.debounceDelay = e.debounceDelay ?? Et),
  ...
  getRecoveryData() {
    ...
    try {
      ...
      if (!e) return null;
      let o = Rt(e);
      return o ? (It(o.savedAt, this.maxAge) ? (this.clear(), null) : o) : null;
    } catch {
      return null;
    }
  }
  ...
  destroy() {
    if ((this.stopTimers(), this._isEnabled && this.currentDocument && this.storageAvailable))
      try {
        this.persistToStorage(_(this.currentDocument));
      } catch (e) {
  ...
  persistToStorage(e) {
    let o = { document: JSON.parse(e), savedAt: new Date().toISOString(), version: P };
...
var b = class extends u {
  constructor() {
    ...
    a(this, '_hasLayout', false);
    a(this, '_selectionRects', []);
    a(this, '_caretPosition', null);
    a(this, '_isDragging', false);
    a(this, '_dragAnchor', null);
    a(this, '_columnResize', {
      isResizing: false,
      startX: 0,
      columnIndex: 0,
      tablePmStart: 0,
    ...
    a(this, '_selectedImageInfo', null);
    a(this, '_isImageInteracting', false);
    a(this, '_isFocused', false);
    a(this, '_version', 0);
  }
  setLayoutReady(e) {
...
var x = class extends u {
  constructor(e = {}) {
    ...
    a(this, '_loadingState', 'idle');
    a(this, '_parseError', null);
    a(this, '_zoom');
    a(this, '_fontsLoaded', false);
    a(this, '_document', null);
    a(this, '_version', 0);
...
var sn = '0.0.2';
export {
  h as AutoSaveManager,
  x as EditorCoordinator,
  S as ErrorManager,
  b as LayoutCoordinator,
  v as PluginLifecycleManager,
  u as Subscribable,
  m as TABLE_DATA_ATTRIBUTES,
  f as TableSelectionManager,
  sn as VERSION,
  xt as countPageBreaks,
  mt as createColumnBreak,
  k as createHorizontalRule,
  dt as createLineBreak,
  E as createPageBreak,
  R as createPageBreakParagraph,
  gt as createPageBreakRun,
  $ as createSelectionFromDOM,
  V as deleteTableFromDocument,
  y as extractFormattingFromElement,
  yt as findPageBreaks,
  O as findTableFromClick,
  B as formatLastSaveTime,
  w as formatStorageSize,
  F as getAutoSaveStatusLabel,
  z as getAutoSaveStorageSize,
  C as getSelectionRuns,
  M as getTableFromDocument,
  g as hasPageBreakBefore,
  J as injectStyles,
  ft as insertHorizontalRule,
  ht as insertPageBreak,
  N as isAutoSaveSupported,
  bt as isBreakContent,
  St as isColumnBreak,
  vt as isLineBreak,
  d as isPageBreak,
  Ct as removePageBreak,
  T as rgbToHex,
  H as updateTableInDocument,
