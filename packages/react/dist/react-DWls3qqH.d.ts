...
import { T as TextFormatting, w as ParagraphFormatting, D as Document, X as Theme, e as Table } from './agentApi-DfsWRyrP.js';
import { P as PageIndicatorPosition, e as PageNavigatorPosition, c as PageIndicatorVariant, g as PageNavigatorVariant, m as PrintOptions, o as TableContext, T as TableAction, j as ParsedClipboardContent } from './clipboard-BE8E-szx.js';
import { f as DocxInput, D as DocumentAgent } from './DocumentAgent-BHR0CMGb.js';
import { g as EditorPluginCore, k as PluginPanelProps, R as RenderedDomContext, f as EditorHandle, h as ErrorNotification, m as SavedDocumentData, d as AutoSaveStatus, e as ClipboardSelection } from './ClipboardManager-jqJVxB6g.js';
