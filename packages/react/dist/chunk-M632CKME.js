...
var Tp = 340,
  ...
  Tl = ({
    ...
    let [S, w] = useState(null),
      ...
      P = useCallback(() => {
        ...
        let ue = new Map(),
          Ee = 0;
        for (let me of de) {
          let Se = Math.max(me.targetY, Ee + vp);
        ...
        if (!he.current?.contains(de)) {
          if (z.contains(de)) {
            ...
            if (ue?.dataset.commentId) {
              (O(`comment-${ue.dataset.commentId}`), n?.(Number(ue.dataset.commentId)));
              return;
            }
    ...
    let I = () => {
      ...
      y = (v, z) => {
        (O(V === v ? null : v), _(null), z !== void 0 && n?.(z));
      },
      M = W.size > 0,
      L = (v, z = 32) => ({
        width: z,
          ...
          'div',
          {
            ...
            children: [
              jsxs('div', {
                style: { display: 'flex', alignItems: 'flex-start', gap: 10 },
                children: [
                  jsx('div', { style: L(v.author || 'U'), children: Ea(v.author || 'U') }),
                  jsxs('div', {
                    style: { flex: 1, minWidth: 0 },
                    children: [
                      jsx('div', {
                  ...
                  ie &&
                    jsxs('div', {
                      ...
                      children: [
                        ...
                        jsx('button', {
                          onClick: (ue) => {
                            (ue.stopPropagation(), _(F === D ? null : D));
                          },
                          title: 'More options',
                          style: hr,
          ...
          'div',
          {
            ...
            children: [
              jsxs('div', {
                style: { display: 'flex', alignItems: 'flex-start', gap: 10 },
                children: [
                  jsx('div', { style: L(D), children: Ea(D) }),
                  jsxs('div', {
                    style: { flex: 1, minWidth: 0 },
                    children: [
                      jsx('div', {
  ...
  let [l, u] = useState(null),
    ...
    E = useCallback(
      (O) => {
        ...
        let F = p.current.getBoundingClientRect(),
          _ = O.clientY - F.top,
          W = s(_ / t);
        if (l === 'topMargin') {
          let K = f - b - 720,
  ...
  return jsxs('div', {
    ...
    children: [
      jsx('div', {
        ...
        children: $.map((O, F) => jsx(Hp, { tick: O }, F)),
      }),
      jsx(Pl, {
        type: 'topMargin',
        position: S,
      ...
      jsx(Pl, {
        ...
        onMouseLeave: () => c(null),
        onMouseDown: (O) => k(O, 'bottomMargin'),
      }),
    ],
  });
}
...
var yf = je({ name: 'table', schemaNodeName: 'table', nodeSpec: ff }),
  ...
  wf = Mt({
    ...
    onSchemaReady(e) {
      ...
      function n(...P) {
        return (I, y, M) => {
          for (let L of P) if (L(I, y, M)) return true;
          return false;
        };
      }
      function o(P, I = {}) {
      ...
      function r(P, I, y = '000000', M = 9360) {
        ...
        for (let xe = 0; xe < P; xe++) {
          ...
          L.push(t.nodes.tableRow.create({ height: U, heightRule: Q }, v));
        }
        let G = Array(I).fill(A);
        return t.nodes.table.create({ columnWidths: G, width: M, widthType: 'dxa' }, L);
      }
      function i(P, I) {
        return (y, M) => {
          let { $from: L } = y.selection,
            A = '000000',
            U = y.storedMarks || L.marks();
          for (let N of U)
      ...
      function a(P, I) {
        ...
        if (I) {
          ...
          let U = t.nodes.tableRow.create(
              { height: L.attrs.height ?? 360, heightRule: L.attrs.heightRule ?? 'atLeast' },
              A
            ),
            Q = y.tablePos + 1;
      ...
      function l(P, I) {
        ...
        if (I) {
          let M = P.tr,
            L = y.tablePos + 1;
          for (let U = 0; U < y.rowIndex; U++) L += y.table.child(U).nodeSize;
          let A = L + y.table.child(y.rowIndex).nodeSize;
          (M.delete(L, A), I(M.scrollIntoView()));
        }
        return true;
      }
      function u(P, I) {
      ...
      function f(P, I) {
        ...
        if (I) {
          let M = y.tablePos + 1,
            ...
            U = CellSelection.create(P.doc, L.pos, A.pos);
      ...
      function b(P, I) {
        ...
        if (I) {
          let M = y.tablePos + 1,
            ...
            U = M + 1;
          for (let G = 0; G < y.columnIndex && G < L.childCount; G++) U += L.child(G).nodeSize;
          let Q = M;
      ...
      function g(P) {
        ...
        let { $from: M } = I;
        for (let L = M.depth; L > 0; L--) {
          let A = M.node(L);
          if (A.type.name === 'tableCell' || A.type.name === 'tableHeader') {
            y.push({ pos: M.before(L), node: A });
            break;
          }
        }
        return y;
      ...
      function S(P, I) {
        ...
        return (
          ...
          { cellByPos: y, cellByRC: M, totalRows: L, totalCols: A }
        );
      }
      function w(P, I) {
        return (y, M) => {
        ...
        return (I, y) => {
          ...
          if (y) {
            ...
            for (let { pos: Q, node: N } of A)
              L.setNodeMarkup(L.mapping.map(Q), void 0, { ...N.attrs, backgroundColor: U });
            y(L.scrollIntoView());
          }
          return true;
        };
        ...
        return (I, y) => {
          ...
          if (y) {
            ...
            for (let { pos: U, node: Q } of A)
              L.setNodeMarkup(L.mapping.map(U), void 0, { ...Q.attrs, verticalAlign: P });
            y(L.scrollIntoView());
          }
          return true;
        };
        ...
        return (I, y) => {
          ...
          if (y) {
            ...
            for (let { pos: U, node: Q } of A) {
              ...
              L.setNodeMarkup(L.mapping.map(U), void 0, { ...Q.attrs, margins: j });
            }
            y(L.scrollIntoView());
          }
          return true;
        ...
        return (I, y) => {
          ...
          if (y) {
            let L = I.tr,
              A = g(I);
            for (let { pos: U, node: Q } of A)
              L.setNodeMarkup(L.mapping.map(U), void 0, { ...Q.attrs, textDirection: P });
            y(L.scrollIntoView());
          }
          return true;
        };
      ...
      function _() {
        return (P, I) => {
          ...
          if (I) {
            ...
            ((M = M.setNodeMarkup(y.tablePos, void 0, { ...L.attrs, columnWidths: G })),
              I(M.scrollIntoView()));
          }
          return true;
        };
        ...
        return (I, y) => {
          ...
          if (y) {
            let L = I.tr,
              ...
              j = P.conditionals ?? {},
              G = P.tableBorders;
            L = L.setNodeMarkup(U, void 0, { ...A.attrs, styleId: P.styleId });
            let xe = 0,
              v = U + 1;
            for (let z = 0; z < Q; z++) {
              let D = A.child(z),
              ...
              for (let pe = 0; pe < Ee; pe++) {
                ...
                (Object.keys(ze).length > 0 ? (it.borders = ze) : (it.borders = null),
                  (L = L.setNodeMarkup(Qe, void 0, it)),
                  (Se += $e.nodeSize));
              }
              v += D.nodeSize;
            }
        ...
        return (I, y) => {
          ...
          if (y) {
            ...
            ('width' in P && (A.width = P.width),
              ...
              L.setNodeMarkup(M.tablePos, void 0, A),
              y(L.scrollIntoView()));
          }
          return true;
        };
      ...
      function ee(P) {
        return (I, y) => {
          ...
          if (y) {
            ...
            for (let [D, ie] of G) L.setNodeMarkup(L.mapping.map(D), void 0, ie);
            y(L.scrollIntoView());
          }
          return true;
        };
      ...
      function he(P) {
        return (I, y) => {
          ...
          if (y) {
            ...
            for (let [z, D] of j) L.setNodeMarkup(L.mapping.map(z), void 0, D);
            y(L.scrollIntoView());
          }
          return true;
        };
      ...
      function fe() {
        return (P, I) => {
          ...
          if (
            ...
            return false;
          if (I) {
            let N = P.tr.delete(L.tablePos, L.tablePos + L.table.nodeSize);
            I(N.scrollIntoView());
          }
          return true;
        };
          ...
          props: {
            decorations(P) {
              ...
              for (let M = y.depth; M > 0; M--) {
                let L = y.node(M);
                if (L.type.name === 'tableCell' || L.type.name === 'tableHeader') {
                  let A = y.before(M);
                  return DecorationSet.create(P.doc, [
                    Decoration.node(A, A + L.nodeSize, { class: 'activeCell' }),
                  ]);
                }
              }
  ...
  let n = nm(e),
    ...
    w = e.rows.map((k, E) => {
      let R = E === 0 && !!a?.firstRow,
        $ = E === g - 1 && !!a?.lastRow,
        V = f && !R && !$ ? (b % 2 === 0 ? p.band1Horz : p.band2Horz) : void 0;
      return (f && !R && !$ && b++, om(k, t, R, o, r, p, V, m, a, l, E, g, S, n, d));
    });
...
function om(e, t, n, o, r, i, a, s, l, u, d, c, p, f, m) {
  let b = {
    ...
    V = 0,
    O = [];
  for (let F = 0; F < e.cells.length; F++) {
    let _ = e.cells[F],
    ...
    if (o && r && r > 0) {
      let U = 0;
      for (let Q = 0; Q < W && V + Q < o.length; Q++) U += o[V + Q];
      he = Math.round((U / r) * 100);
    }
    if (((V += W), B)) continue;
    let fe = V - W === 0,
      Ie = V === $,
      Te = _.formatting?.conditionalFormat,
      Re = Te?.firstRow ?? E,
      P = Te?.lastRow ?? R,
      I = Te?.firstColumn ?? fe,
      y = Te?.lastColumn ?? Ie,
    ...
    let L = a;
    (k?.oddHBand ? (L = i?.band1Horz) : k?.evenHBand && (L = i?.band2Horz),
      Te?.oddHBand ? (L = i?.band1Horz) : Te?.evenHBand && (L = i?.band2Horz));
    let A = i?.wholeTable;
    ((A = nn(A, L)),
      (A = nn(A, M)),
      ...
      P &&
        ...
        (l?.lastColumn || k?.lastColumn || Te?.lastColumn) &&
        (A = nn(A, i?.seCell)),
      O.push(rm(_, t, n, he, A, u, S, w, fe, Ie, ee, m)));
  }
  return ye.node('tableRow', b, O);
}
function rm(e, t, n, o, r, i, a, s, l, u, d, c) {
  ...
  for (let O of e.content)
    O.type === 'paragraph'
      ? $.push(vr(O, t, void 0, r?.rPr))
      : O.type === 'table' && $.push(Ha(O, t));
  $.length === 0 && $.push(ye.node('paragraph', {}, []));
...
var pd = {
  ...
  gd = forwardRef(function (
    ...
    (useLayoutEffect(() => {
      ...
      O();
      let F = i.closest('[style*="overflow"]') || i;
      return (
        F.addEventListener('scroll', O),
        window.addEventListener('resize', O),
        () => {
          (F.removeEventListener('scroll', O), window.removeEventListener('resize', O));
        }
      );
    }, [r, i]),
      useEffect(() => {
        if (!c.current || p.current) return;
        let O = $a(t.content, { styles: o || void 0 }),
          F = new Sn(lo());
        (F.buildSchema(), F.initializeRuntime());
        let _ = F.getPlugins(),
          W = EditorState.create({ doc: O, schema: ye, plugins: _ }),
    ...
    (useEffect(() => {
      ...
      useEffect(() => {
        if (!b) return;
        function O(F) {
          S.current && !S.current.contains(F.target) && g(false);
        }
        return (
      ...
      useImperativeHandle(d, () => ({
        ...
        undo: () => {
          let O = p.current;
          return O ? undo(O.state, O.dispatch) : false;
        },
        redo: () => {
          let O = p.current;
          return O ? redo(O.state, O.dispatch) : false;
        },
      })));
    let $ = n === 'header' ? 'Header' : 'Footer';
    if (!w) return null;
...
function tg(e, t = {}) {
  let {
          ...
          ? p((C) => {
              ...
              return (
                (B[B.length - 1] = {
                  state: u,
                  timestamp: W,
                  description: _ || B[B.length - 1].description,
                }),
                B
              );
            })
          : p((C) => {
              let B = { state: u, timestamp: W, description: _ },
                ee = [...C, B];
    ...
    O = useCallback((F) => {
      (d((_) => F(_)),
        p((_) => _.map((W) => ({ ...W, state: F(W.state) }))),
        m((_) => _.map((W) => ({ ...W, state: F(W.state) }))));
    }, []);
  return (
    useEffect(() => {
      if (!r) return;
...
var gg = forwardRef(function (t, n) {
        ...
        let C = {
          ...
          dispatchTransaction: (B) => {
            ...
            (g.current.updateState(ee),
              R.current?.(B, ee),
              (B.selectionSet || B.docChanged) && $.current?.(ee));
          },
          handleKeyDown: (B, ee) => F.current?.(B, ee) ?? false,
    ...
    return (
      ...
      useEffect(() => {
        ...
        let B = Id(o, r, c, d);
        (g.current.updateState(B), $.current?.(B));
      }, [o, r, c, d]),
      useEffect(() => {
        g.current;
      }, [s]),
...
function zd({
        ...
        let I = 4,
          ...
          Q = (N) => {
            if (
              ...
              let j = W.current;
              (j && O.current?.(j.pmPos, N.clientX, N.clientY), _.current?.());
            }
          };
  ...
  return jsxs('div', {
    ...
    children: [
      jsx('div', {
        style: { ...Eg, left: fe - _o, top: Ie - _o, width: Te + _o * 2, height: Re + _o * 2 },
      }),
      jsx('div', {
        style: {
          position: 'absolute',
      ...
      jsx(Fi, { handle: 'nw', style: { left: fe - Tn, top: Ie - Tn }, onMouseDown: B }),
      jsx(Fi, { handle: 'ne', style: { left: fe + Te - Tn, top: Ie - Tn }, onMouseDown: B }),
      jsx(Fi, { handle: 'se', style: { left: fe + Te - Tn, top: Ie + Re - Tn }, onMouseDown: B }),
      jsx(Fi, { handle: 'sw', style: { left: fe - Tn, top: Ie + Re - Tn }, onMouseDown: B }),
      u &&
        jsxs('div', {
          style: { ...Fg, left: fe + Te / 2, top: Ie + Re + 12 },
          children: [f, ' \xD7 ', b],
        }),
    ],
  });
...
function ns(e) {
  ...
  function c() {
    ...
    return (r.push(V), i.push(O), e.onNewPage && e.onNewPage(O), O);
  }
  function p() {
  ...
  function g(E) {
    ...
    if ($ > V) return (R.cursorY !== R.topMargin && (R = b(R)), R);
    for (; !m($, R); ) R = b(R);
    return R;
  }
  function S(E, R, $ = 0, V = 0) {
    let O = Math.max($, p().trailingSpacing),
      F = O + R,
      _ = g(F),
      K = _.cursorY === _.topMargin ? 0 : O,
      C = d(_.columnIndex),
      B = _.cursorY + K;
    return (
      (E.x = C),
...
function jo(e, t, n) {
  ...
  if (o.length === 1 && Gd(o[0]) && sh(o[0])) {
    let F = o[0],
      _ = F.fontSize ?? r?.defaultFontSize ?? pn,
      W = F.fontFamily ?? r?.defaultFontFamily ?? Vo,
      K = Ud(_, i, W);
    return (
  ...
  let k = {
    ...
    E = () => {
      let F = Yd(k.maxFontSize, i, k.maxFontMetrics),
        _ = { ...F };
    ...
    $ = (F) => {
      ...
      (!k.maxFontMetrics || _ > k.maxFontSize) &&
        ((k.maxFontSize = _), (k.maxFontMetrics = d$2(F)));
    };
  for (let F = 0; F < o.length; F++) {
    let _ = o[F];
    if (ih(_)) {
      ((k.toRun = F), (k.toChar = 0), R(F + 1, 0));
      continue;
    }
    if (oh(_)) {
      let W = jd(_);
      $(W);
      let K = _.width ?? ch;
      (k.width + K > k.availableWidth + fo && (R(F, 0), $(W)),
        (k.width += K),
        (k.toRun = F),
        (k.toChar = 1));
      continue;
    ...
    if (rh(_)) {
      ...
      if (W === 'topAndBottom' || _.displayMode === 'block') {
        ...
        let ee = _.height,
          he = _.distTop ?? 6,
          fe = _.distBottom ?? 6;
        ((k.toRun = F), (k.toChar = 1), (k.maxImageHeightPx = ee + he + fe), R(F + 1, 0));
        continue;
      }
      let C = _.width,
        B = _.height;
      (B > k.maxImageHeightPx && (k.maxImageHeightPx = B),
        k.width + C > k.availableWidth + fo && R(F, 0),
        (k.width += C),
        (k.toRun = F),
        (k.toChar = 1));
      continue;
    ...
    if (ah(_)) {
      let W = _.fallback || '1',
        K = {
          ...
          fontSize: _.fontSize ?? pn,
          bold: _.bold,
          italic: _.italic,
        };
      $(K);
      let C = e$2(W, K);
      (k.width > 0 && k.width + C > k.availableWidth + fo && (R(F, 0), $(K)),
        (k.width += C),
        (k.toRun = F),
        (k.toChar = 1));
      continue;
      ...
      for (; ee < K.length; ) {
        ...
        if (Ie > k.availableWidth + fo) {
          ...
          for (; Re < fe.length; ) {
            ...
            for (; I < fe.length; ) {
              let y = Te[I] ?? 0;
              if (P + y > k.availableWidth + fo) break;
              ((P += y), (I += 1));
            }
            (I === Re && ((I = Math.min(fe.length, Re + 1)), (P = Te[Re] ?? 0)),
              ...
              (k.toChar = ee + I),
              (Re = I),
              Re < fe.length && (R(F, ee + Re), $(C)));
          }
          ee = he;
          continue;
        }
        (k.width > 0 && k.width + Ie > k.availableWidth + fo && (R(F, ee), $(C)),
          (k.width += Ie),
          (k.toRun = F),
          (k.toChar = he),
          (ee = he));
  ...
  E();
  let O = w.reduce((F, _) => F + _.lineHeight, 0);
  return (
    i?.before && (O += i.before),
    i?.after && (O += i.after),
    { kind: 'paragraph', lines: w, totalHeight: O }
  );
}
var dh = new Map();
function qd() {
...
function jn(e, t, n, o, r = {}) {
  ...
  if (p) {
    ...
    let E = (O) => `${O.width}px ${k(O.style)} ${O.color}`,
      R = ou(r.prevBorders, p),
      $ = ou(p, r.nextBorders);
    (R && p.between
      ? (a.style.borderTop = E(p.between))
      : p.top && !R && (a.style.borderTop = E(p.top)),
      p.bottom && !$ && (a.style.borderBottom = E(p.bottom)),
  ...
  for (let k = 0; k < s.length; k++) {
    ...
    if (V) {
      ...
      B && u?.hanging ? (_ = f + u.hanging) : ee && u?.firstLine && (_ = f - u.firstLine);
    }
    let W = cu(t, E, l, i, {
      availableWidth: _ - O - F,
      isLastLine: $,
      isFirstLine: V,
    ...
    (O > 0 && (W.style.marginLeft = `${O}px`),
      F > 0 && (W.style.marginRight = `${F}px`),
      (w += E.lineHeight));
    ...
    if (
      ...
      ((W.style.paddingLeft = `${B}px`), (W.style.textIndent = '0'));
...
function $h(e, t, n, o, r, i, a) {
  ...
  if (
    ...
    e.borders &&
      (r.isFirstRow && Ni(s, 'top', e.borders.top),
      Ni(s, 'right', e.borders.right),
      Ni(s, 'bottom', e.borders.bottom),
      r.isFirstCol && Ni(s, 'left', e.borders.left)),
...
function du(e, t, n, o, r, i, a, s, l, u) {
  ...
  for (let m = 0; m < e.cells.length; m++) {
    ...
    if (w > 1 && u) {
      k = 0;
      for (let F = n; F < n + w && F < u.length - 1; F++) k += (u[F + 1] ?? 0) - (u[F] ?? 0);
      k === 0 && (k = t.height * w);
    }
    let E = n === 0,
      $ = f === 0;
    f + S >= r.length;
    let O = $h(b, g, p, k, { isFirstRow: E, isFirstCol: $ }, a, s);
    if (
      ((O.dataset.cellIndex = String(m)),
      (O.dataset.columnIndex = String(f)),
      w > 1 && (O.dataset.rowSpan = String(w)),
      d.appendChild(O),
      w > 1 && l)
    ) {
      let F = `${n}-${f}`;
    ...
    for (let F = 0; F < S && f + F < r.length; F++) p += r[f + F] ?? 0;
...
function ks(e, t, n = {}) {
  ...
  if (a && a.optionsHash === s && l) {
    let g = a.pageStates,
      ...
      w = i.__pageObserver,
      k = [];
    for (let $ of e) k.push(pu($));
    let E = a.totalPages !== o,
      R = Math.min(g.length, e.length);
    for (let $ = 0; $ < R; $++) {
      let V = g[$],
        O = k[$];
      if (V.fingerprint === O && !E) {
        let W = S.get(V.element);
        W && (W.page = e[$]);
        continue;
      }
      let F = V.element,
        _ = S.get(F);
      (_ && ((_.page = e[$]), _.rendered && Zh(F, S, o, n)),
        (V.fingerprint = O),
        $i(F, e[$].size.w, e[$].size.h, n),
        (F.dataset.pageNumber = String(e[$].number)));
    }
    if (e.length > g.length) {
      let $ = n.document ?? document;
      for (let V = g.length; V < e.length; V++) {
        let O = e[V],
          F = $.createElement('div');
        ((F.className = n.pageClassName ?? Mn.page),
          (F.dataset.pageNumber = String(O.number)),
          (F.dataset.pageIndex = String(V)),
          $i(F, O.size.w, O.size.h, n),
          t.appendChild(F),
          g.push({ element: F, fingerprint: k[V] }),
          S.set(F, { page: O, index: V, rendered: false }),
          w && w.observe(F));
      }
    }
    if (e.length < g.length) {
      for (let $ = g.length - 1; $ >= e.length; $--) {
        let V = g[$].element;
  ...
  let m = new IntersectionObserver(
    (g) => {
      ...
      for (let [O, F] of E) {
        ...
        _.bottom > -$ && _.top < R + $ && V.add(F.index);
      }
      for (let [O, F] of E) {
        if (!F.rendered) continue;
        let _ = false;
        for (let W of V)
          if (Math.abs(F.index - W) <= Oi + 1) {
            _ = true;
            break;
          }
        !_ && V.size > 0 && Jh(O, E);
      ...
      for (let f of Array.from(u)) {
        ...
        if (l >= b.left && l <= b.right) {
          ...
          let R = 0,
            $ = k.length;
          for (; R < $; ) {
            let V = Math.floor((R + $) / 2),
              O = E.createRange();
            (O.setStart(k, V),
              O.setEnd(k, V),
              l < O.getBoundingClientRect().left ? ($ = V) : (R = V + 1));
          }
          if (R > 0 && R <= k.length) {
            let V = E.createRange();
            (V.setStart(k, R - 1), V.setEnd(k, R - 1));
            let O = V.getBoundingClientRect().left;
            (V.setStart(k, Math.min(R, k.length)), V.setEnd(k, Math.min(R, k.length)));
            let F = V.getBoundingClientRect().left;
            if (Math.abs(l - O) < Math.abs(l - F)) return g + (R - 1);
          }
...
function vu(e, t) {
  ...
  for (let c = 0; c < l.length; c++) {
    ...
    for (let w = 0; w < p.cells.length; w++) {
      let k = p.cells[w],
        E = f?.[w];
      k.height = k.blocks.reduce((V, O) => ('totalHeight' in O ? V + O.totalHeight : V), 0);
      let R = E?.padding?.top ?? 1,
        $ = E?.padding?.bottom ?? 1;
      ((k.height += R + $), (m = Math.max(m, k.height)));
    }
    let b = e.rows[c],
      g = b?.height,
      S = b?.heightRule;
  ...
  let t = e.rows ?? [],
    ...
    r = t.map((i) => {
      let a = i.formatting,
        l = (i.cells ?? []).map((u) => {
          let d = u.formatting,
            ...
            p = [];
          for (let R of c)
            if (R.type === 'paragraph' && Array.isArray(R.content)) {
              let $ = R.formatting,
                V = {};
              if ($?.alignment) {
                let F = $.alignment;
                F === 'both'
                  ? (V.alignment = 'justify')
                  : ['left', 'center', 'right', 'justify'].includes(F) && (V.alignment = F);
              }
              let O = Jo(R.content);
              O.length > 0 &&
                p.push({
                  ...
                  id: `hf-tbl-p-${Xo++}`,
                  runs: O,
                  attrs: Object.keys(V).length > 0 ? V : void 0,
                });
            } else R.type === 'table' && p.push(Mu(R));
          p.length === 0 &&
            p.push({
              kind: 'paragraph',
              id: `hf-tbl-p-${Xo++}`,
          ...
          let f,
            m = d?.borders;
          m && (f = { top: Xi(m.top), bottom: Xi(m.bottom), left: Xi(m.left), right: Xi(m.right) });
          let b = d?.margins,
            g = {
              top: b?.top?.value != null ? Yn(b.top.value) : 1,
              right: b?.right?.value != null ? Yn(b.right.value) : 7,
              bottom: b?.bottom?.value != null ? Yn(b.bottom.value) : 1,
              left: b?.left?.value != null ? Yn(b.left.value) : 7,
            },
            S = d?.width,
            w = S?.value && S.type === 'dxa' ? Yn(S.value) : void 0,
            k = d?.shading,
            E;
          return (
            k?.fill && k.fill !== 'auto' && (E = `#${k.fill}`),
            {
              id: `hf-tbl-c-${Xo++}`,
              blocks: p,
              colSpan: d?.gridSpan,
      ...
      return {
        id: `hf-tbl-r-${Xo++}`,
        cells: l,
        height: a?.height?.value ? Yn(a.height.value) : void 0,
        heightRule: a?.heightRule,
        isHeader: a?.header,
      };
    });
  return {
...
var yb = forwardRef(function (t, n) {
        ...
        (T) => {
          ...
          try {
            ...
            let zt,
              ...
              So = new Map();
            if (we) {
              let bn = Li(Y, J, { pageSize: Oe, margins: Dt });
              ((Hn = Cs(bn.pages, ce)), (So = bu(o.package.footnotes, ce, Lt)));
              let Qt = yu(Hn, So);
              if (Qt.size > 0) {
                ((zt = Li(Y, J, { pageSize: Oe, margins: Dt, footnoteReservedHeights: Qt })),
                  (Hn = Cs(zt.pages, ce)));
                for (let [nt, Nn] of Hn) {
            ...
            } else zt = Li(Y, J, { pageSize: Oe, margins: Dt });
            if (
              ((Z = performance.now() - X),
              Z > 500 &&
                console.warn(
            ...
            ko > 2e3 &&
              console.warn(
                `[PagedEditor] Layout pipeline took ${Math.round(ko)}ms total (${Y.length} blocks, ${J.length} measures)`
              );
          } catch (X) {
    ...
    let ea = useCallback(
      ...
      ht = useCallback((T) => {
        ...
        (ne && W.current?.contains(ne)) || U(false);
      }, []),
                ...
                children: [
                  ...
                  jsxs(Suspense, {
                    ...
                    children: [
                      ...
                      U && jsx(vb, { isOpen: U, onClose: () => Q(false), onApply: X }),
                      N &&
                        jsx(Rb, {
                          isOpen: N,
                          onClose: () => j(false),
...
`,
  qb = forwardRef(function ({ plugins: t, children: n, className: o = '' }, r) {
    ...
    let [l, u] = useState(null),
      ...
      [p, f] = useState(() => {
        let C = new Set();
        for (let B of t) ({ ...Qi, ...B.panelConfig }).defaultCollapsed && C.add(B.id);
        return C;
      }),
      [m] = useState(() => {
        let C = new Map();
        for (let B of t) {
          let ee = { ...Qi, ...B.panelConfig };
    ...
    (useEffect(() => {
      ...
      useEffect(() => {
        let C = t.filter((B) => B.styles).map((B) => Ku(B.id, B.styles));
...
export {
  ...
  Nu as y,
  $b as z,
}; //# sourceMappingURL=chunk-M632CKME.js.map
//# sourceMappingURL=chunk-M632CKME.js.map
