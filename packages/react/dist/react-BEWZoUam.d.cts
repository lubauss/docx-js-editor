...
import { T as TextFormatting, w as ParagraphFormatting, D as Document, X as Theme, e as Table } from './agentApi-DfsWRyrP.cjs';
import { P as PageIndicatorPosition, e as PageNavigatorPosition, c as PageIndicatorVariant, g as PageNavigatorVariant, m as PrintOptions, o as TableContext, T as TableAction, j as ParsedClipboardContent } from './clipboard-DkfAv07F.cjs';
import { f as DocxInput, D as DocumentAgent } from './DocumentAgent-Biwj6DbV.cjs';
import { g as EditorPluginCore, k as PluginPanelProps, R as RenderedDomContext, f as EditorHandle, h as ErrorNotification, m as SavedDocumentData, d as AutoSaveStatus, e as ClipboardSelection } from './ClipboardManager-B1jZrC6h.cjs';
...
export { getSelectionRects as $, type UseTableSelectionOptions as A, type UseTableSelectionReturn as B, type UseWheelZoomOptions as C, DEFAULT_SELECTION_STYLE as D, type EditorPlugin as E, type UseWheelZoomReturn as F, areSelectionStylesInjected as G, HIGH_CONTRAST_SELECTION_STYLE as H, clampZoom as I, clearSelection as J, createSelectionChangeHandler as K, findNearestZoomPreset as L, formatZoom as M, generateOverlayElements as N, generateSelectionCSS as O, PLUGIN_HOST_STYLES as P, getHighlightRectStyle as Q, type ReactEditorPlugin as R, SELECTION_CSS_VARS as S, type TableSelectionState as T, UnsupportedFeatureWarning as U, getMergedSelectionRects as V, getNextZoomPreset as W, getPreviousZoomPreset as X, getSelectedText as Y, ZOOM_PRESETS as Z, getSelectionBoundingRect as _, DocxEditor as a, getUserFriendlyMessage as a0, getZoomPresets as a1, hasActiveSelection as a2, highlightTextRange as a3, injectSelectionStyles as a4, isParseError as a5, isSelectionBackwards as a6, isSelectionWithin as a7, isZoomPreset as a8, mergeAdjacentRects as a9, normalizeSelectionDirection as aa, parseZoom as ab, removeSelectionStyles as ac, renderAsync as ad, selectRange as ae, useAutoSave as af, useClipboard as ag, useErrorNotifications as ah, useSelectionHighlight as ai, useTableSelection as aj, useWheelZoom as ak, type DocxEditorHandle as b, type DocxEditorProps as c, type DocxEditorRef as d, ErrorBoundary as e, type ErrorBoundaryProps as f, type ErrorContextValue as g, ErrorProvider as h, type HighlightRect as i, ParseErrorDisplay as j, type ParseErrorDisplayProps as k, type PluginContext as l, PluginHost as m, type PluginHostProps as n, type PluginHostRef as o, type RenderAsyncOptions as p, type SelectionHighlightConfig as q, type SelectionOverlayProps as r, type SelectionRange as s, type UnsupportedFeatureWarningProps as t, type UseAutoSaveOptions as u, type UseAutoSaveReturn as v, type UseClipboardOptions as w, type UseClipboardReturn as x, type UseSelectionHighlightOptions as y, type UseSelectionHighlightReturn as z };
